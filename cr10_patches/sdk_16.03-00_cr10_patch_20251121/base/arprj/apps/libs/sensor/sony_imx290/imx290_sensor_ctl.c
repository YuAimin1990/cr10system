...
int imx290_flip_off_mirro_off(VI_PIPE ViPipe)
{
    imx290_write_register(ViPipe, IMX290_FLIP_MIRRO, 0x00);
    return 0;
}

int imx290_flip_on_mirro_off(VI_PIPE ViPipe)
{
    imx290_write_register(ViPipe, IMX290_FLIP_MIRRO, 0x01);
    return 0;
}

int imx290_flip_off_mirro_on(VI_PIPE ViPipe)
{
    imx290_write_register(ViPipe, IMX290_FLIP_MIRRO, 0x02);
    return 0;
}

int imx290_flip_on_mirro_on(VI_PIPE ViPipe)
{
    imx290_write_register(ViPipe, IMX290_FLIP_MIRRO, 0x03);
    return 0;
}
...
void imx290_linear_1080p60_init(VI_PIPE ViPipe);
...
void imx290_default_reg_init(VI_PIPE ViPipe)
{
    ...
    {
        //ar_always("set reg[0x%x]: 0x%x \n", g_pastImx290[ViPipe]->astRegsInfo[0].astI2cData[i].u32RegAddr,  g_pastImx290[ViPipe]->astRegsInfo[0].astI2cData[i].u32Data);
        if (g_pastImx290[ViPipe]->astRegsInfo[0].astI2cData[i].bUpdate)
        {
            //ar_printf("set reg[0x%x]: 0x%x \n", g_pastImx290[ViPipe]->astRegsInfo[0].astI2cData[i].u32RegAddr,  g_pastImx290[ViPipe]->astRegsInfo[0].astI2cData[i].u32Data);
...
void imx290_init(VI_PIPE ViPipe)
{
    ...
    if (AR_FALSE == bInit)
    {
        ...
        {
            if (IMX290_SENSOR_1080P_30FPS_LINEAR_MODE == u8ImgMode)
			{
				imx290_linear_1080p30_init(ViPipe);
			}
			else if (IMX290_SENSOR_1080P_60FPS_LINEAR_MODE == u8ImgMode) 
			{
				imx290_linear_1080p60_init(ViPipe);
			}
			else
			{
				imx290_linear_1080p30_init(ViPipe);
    ...
    g_pastImx290[ViPipe]->bInit = AR_TRUE;
    return ;
}

void imx290_trigger(VI_PIPE ViPipe, AR_S32 s32Frames)
{	
    imx290_write_register (ViPipe, 0x3000, 0x00); /* standby */	
    imx290_write_register (ViPipe, 0x3002, 0x00); /* master mode start */
	
    ar_always("===Imx290 trigger stream on!=====\n");
}


void imx290_stream_on(VI_PIPE ViPipe)
{
    imx290_write_register (ViPipe, 0x3000, 0x00); /* standby */	
    imx290_write_register (ViPipe, 0x3002, 0x00); /* master mode start */
	
    ar_always("===Imx290 imx290_stream_on!=====\n");
}
...
{	 
    ...
    imx290_write_register (ViPipe, 0x3002, 0x01); /* standby */
	imx290_write_register (ViPipe, 0x3000, 0x01); /* master mode start */
    ar_always("===Imx290 trigger stream off!=====\n");
...
void imx290_linear_1080p30_init(VI_PIPE ViPipe)
{
    imx290_write_register (ViPipe,0x3002,0x00);
    imx290_write_register (ViPipe,0x3005,0x01);
    imx290_write_register (ViPipe,0x3007,0x00);

    imx290_write_register (ViPipe,0x3009,0x02);

    imx290_write_register (ViPipe,0x300A,0xF0);
    imx290_write_register (ViPipe,0x3011,0x0a);

    imx290_write_register (ViPipe,0x3018,0x65);	//dg 
    imx290_write_register (ViPipe,0x3019,0x04);	//dg

    imx290_write_register (ViPipe,0x301c,0x30);
    imx290_write_register (ViPipe,0x301d,0x11);
    ...
    imx290_write_register (ViPipe,0x309e,0x4a);
    imx290_write_register (ViPipe,0x309f,0x4a);

    imx290_write_register (ViPipe,0x311C,0x0E);
    imx290_write_register (ViPipe,0x3128,0x04);
    imx290_write_register (ViPipe,0x3129,0x00);
    imx290_write_register (ViPipe,0x313b,0x41);
    imx290_write_register (ViPipe,0x315E,0x1A);
    imx290_write_register (ViPipe,0x3164,0x1A);
    imx290_write_register (ViPipe,0x317C,0x00);
    imx290_write_register (ViPipe,0x31EC,0x0E);

    imx290_write_register (ViPipe,0x3404,0x01);
    imx290_write_register (ViPipe,0x3405,0x10);

    imx290_write_register (ViPipe,0x3407,0x01);
    imx290_write_register (ViPipe,0x3414,0x0A);
    imx290_write_register (ViPipe,0x3418,0x38);
    imx290_write_register (ViPipe,0x3419,0x04);
    imx290_write_register (ViPipe,0x3441,0x0C);
    imx290_write_register (ViPipe,0x3442,0x0C);
    imx290_write_register (ViPipe,0x3443,0x01);
    ...
    imx290_write_register (ViPipe,0x3472,0x80);
...
void imx290_linear_1080p60_init(VI_PIPE ViPipe)
{
    ...
    imx290_write_register (ViPipe,0x3009,0x01);	//dg for 60fps
    ...
    imx290_write_register (ViPipe,0x301c,0x98); //dg	for 60fps
    imx290_write_register (ViPipe,0x301d,0x08); //dg
    ...
    imx290_write_register (ViPipe,0x3405,0x00);	// dg for 60fps
    ...
    imx290_write_register (ViPipe,0x3446,0x77);	// dg for 60fps
    imx290_write_register (ViPipe,0x3447,0x00);

    imx290_write_register (ViPipe,0x3448,0x67);	// dg for 60fps
    imx290_write_register (ViPipe,0x3449,0x00);

    imx290_write_register (ViPipe,0x344A,0x47); // dg for 60fps
    imx290_write_register (ViPipe,0x344B,0x00);

    imx290_write_register (ViPipe,0x344C,0x37); // dg for 60fps
    imx290_write_register (ViPipe,0x344D,0x00);

    imx290_write_register (ViPipe,0x344E,0x3F); // dg for 60fps
    imx290_write_register (ViPipe,0x344F,0x00);

    imx290_write_register (ViPipe,0x3450,0xFF); // dg for 60fps
    imx290_write_register (ViPipe,0x3451,0x00);

    imx290_write_register (ViPipe,0x3452,0x03); // dg for 60fps
    imx290_write_register (ViPipe,0x3453,0x00);

    imx290_write_register (ViPipe,0x3454,0x37); // dg for 60fps
    imx290_write_register (ViPipe,0x3455,0x00);
...
void imx290_wdr_1080p30_2to1_init(VI_PIPE ViPipe)
{
    ...
    ar_always("===Imx290 sensor 1080P15fps 10bit 2to1 WDR(30fps->15fps) init success!=====\n");
...
void imx290_wdr_1080p60_2to1_init(VI_PIPE ViPipe)
{
    ...
    imx290_write_register(ViPipe,0x3003,0x01);
    imx290_write_register(ViPipe,0x3002,0x01);
    imx290_write_register(ViPipe,0x3000,0x01);
    imx290_write_register(ViPipe,0x3005,0x01);
    imx290_write_register(ViPipe,0x3007,0x00);
    ...
    imx290_write_register(ViPipe,0x3012,0x64);
    imx290_write_register(ViPipe,0x3016,0x09);
    imx290_write_register(ViPipe,0x3018,0x46);
    imx290_write_register(ViPipe,0x3019,0x05);  //vmax 1350
    imx290_write_register(ViPipe,0x301C,0x98);
    imx290_write_register(ViPipe,0x301D,0x08);  //hmax 2200
    imx290_write_register(ViPipe,0x3020,0x02);  //sexp = 92
    imx290_write_register(ViPipe,0x3021,0x00);
    imx290_write_register(ViPipe,0x3024,0x59);  //lexp = 92*16 = 1520
    imx290_write_register(ViPipe,0x3025,0x03);
    imx290_write_register(ViPipe,0x3030,0xcd);  //rhs = 2n+5 = 95
    ...
    imx290_write_register(ViPipe,0x3418,0x76); //pic height 2678
    imx290_write_register(ViPipe,0x3419,0x0a); //pic height
    imx290_write_register(ViPipe,0x3441,0x0C);
    imx290_write_register(ViPipe,0x3442,0x0C);
    imx290_write_register(ViPipe,0x3443,0x01);
    imx290_write_register(ViPipe,0x3444,0x20);
    ...
    imx290_write_register(ViPipe,0x3472,0xA0);  //pic width 1952
    imx290_write_register(ViPipe,0x3473,0x07);  //pic width
    imx290_write_register(ViPipe,0x347B,0x23);
    imx290_write_register(ViPipe,0x3010,0x61); //set dol2 long exp gain enable
    imx290_write_register(ViPipe,0x30f0,0x64); //set dol2 shot exp gain enable
	imx290_write_register(ViPipe,0x3404, 0x01);
	//imx290_write_register(ViPipe, 0x3448, 0xff);
    ...
    ar_always("===Imx290 sensor 1080P30fps 12bit 2to1 WDR(60fps->30fps) init success!=====\n");
...
void imx290_wdr_1080p30_3to1_init(VI_PIPE ViPipe)
{
    ...
    ar_always("===Imx290 imx290 1080P15fps 12bit 3to1 WDR(30fps->7p5fps) init success!=====\n");
...
void imx290_wdr_720p60_2to1_init(VI_PIPE ViPipe)
{
    ...
    ar_always("===Imx290 imx290 720P30fps 12bit 2to1 WDR(60fps->30fps) init success!=====\n");
...
void imx290_wdr_720p60_3to1_init(VI_PIPE ViPipe)
{
    ...
    ar_always("===Imx290 imx290 720P15fps 12bit 3to1 WDR(60fps->15fps) init success!=====\n");
    return;
}
...
void imx290_wdr_1080p120_2to1_init(VI_PIPE ViPipe)
{
    ...
    ar_always("===Imx290 imx290 1080P60fps 10bit 2to1 WDR(120fps->60fps) init success!=====\n");
    return;
}
...
void imx290_wdr_1080p120_3to1_init(VI_PIPE ViPipe)
{
    ...
    imx290_write_register (ViPipe, 0x3021, 0x00);
    //imx290_write_register (ViPipe,0x3022, 0x00);
    ...
    imx290_write_register (ViPipe, 0x3029, 0x02);
    //imx290_write_register (ViPipe,0x302A, 0x00);
    ...
    ar_always("===Imx290 imx290 1080P30fps 10bit 3to1 WDR(120fps->30fps) init success!=====\n");
