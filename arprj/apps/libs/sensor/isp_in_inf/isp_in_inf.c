...
static AR_S32 cmos_get_isp_default(VI_PIPE ViPipe, ISP_CMOS_DEFAULT_S *pstDef)
{
    ...
    switch (pstSnsState->enWDRMode)
    {
        ...
        break;*/
        default:
            strcpy(pstDef->TuningPraBinName,"/usrdata/local/factory/tunning/cam_common_inf/common_infrared_tuning_preview.bin");
...
ISP_SNS_OBJ_S stSnsIspInInfObj =
{
