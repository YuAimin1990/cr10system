#if !defined(__IMX290_2_CMOS_H_)
#define __IMX290_2_CMOS_H_
...
#define IMX290_2_ID 290

/****************************************************************************
 * global variables                                                            *
 ****************************************************************************/

ISP_SNS_STATE_S *g_pastImx290_2[ISP_MAX_PIPE_NUM] = {AR_NULL};

#define IMX290_2_SENSOR_GET_CTX(dev, pstCtx)   (pstCtx = g_pastImx290_2[dev])
#define IMX290_2_SENSOR_SET_CTX(dev, pstCtx)   (g_pastImx290_2[dev] = pstCtx)
#define IMX290_2_SENSOR_RESET_CTX(dev)         (g_pastImx290_2[dev] = AR_NULL)

ISP_SNS_COMMBUS_U g_aunImx290_2BusInfo[ISP_MAX_PIPE_NUM] =
{
    [0] = { .s8I2cDev = 1},
...
extern const unsigned int imx290_2_i2c_addr;
extern unsigned int imx290_2_addr_byte;
extern unsigned int imx290_2_data_byte;

typedef struct arIMX290_2_STATE_S
{
    AR_U8       u8Hcg;
    AR_U32      u32BRL;
    AR_U32      u32RHS1_MAX;
...
IMX290_2_STATE_S g_astimx290_2State[ISP_MAX_PIPE_NUM] = {{0}};

extern void imx290_2_init(VI_PIPE ViPipe);
extern void imx290_2_exit(VI_PIPE ViPipe);
extern void imx290_2_standby(VI_PIPE ViPipe);
extern void imx290_2_restart(VI_PIPE ViPipe);
extern int  imx290_2_write_register(VI_PIPE ViPipe, int addr, int data);
extern int  imx290_2_read_register(VI_PIPE ViPipe, int addr);
extern void imx290_2_default_reg_init(VI_PIPE ViPipe);
extern int  imx290_2_flip_off_mirro_off(VI_PIPE ViPipe);
extern int  imx290_2_flip_off_mirro_on(VI_PIPE ViPipe);
extern int  imx290_2_flip_on_mirro_off(VI_PIPE ViPipe);
extern int  imx290_2_flip_on_mirro_on(VI_PIPE ViPipe);

/****************************************************************************
 * local variables                                                            *
 ****************************************************************************/
#define IMX290_2_FULL_LINES_MAX  (0x3FFFF)
#define IMX290_2_FULL_LINES_MAX_2TO1_WDR  (0x8AA)    // considering the YOUT_SIZE and bad frame
#define IMX290_2_FULL_LINES_MAX_3TO1_WDR  (0x7FC)

/*****Imx290_2 Register Address*****/
#define IMX290_2_SHS1_ADDR (0x3020)
#define IMX290_2_SHS2_ADDR (0x3024)
#define IMX290_2_SHS3_ADDR (0x3028)
#define IMX290_2_GAIN_ADDR (0x3014)
#define IMX290_2_SGAIN_ADDR (0x30f2)
#define IMX290_2_HCG_ADDR  (0x3009)
#define IMX290_2_VMAX_ADDR (0x3018)
#define IMX290_2_HMAX_ADDR (0x301c)
#define IMX290_2_RHS1_ADDR (0x3030)
#define IMX290_2_RHS2_ADDR (0x3034)
#define IMX290_2_Y_OUT_SIZE_ADDR (0x3418)
#define IMX290_2_FLIP_MIRRO (0x3007)
#define IMX290_2_INCREASE_LINES (1) /* make real fps less than stand fps because NVR require*/


#define IMX290_2_VMAX_1080P30_LINEAR  (1124+IMX290_2_INCREASE_LINES)	// dg
#define IMX290_2_VMAX_1080P30_WDR     (1349+IMX290_2_INCREASE_LINES)
#define IMX290_2_VMAX_720P60TO30_WDR  (750+IMX290_2_INCREASE_LINES)
#define IMX290_2_VMAX_1080P60TO30_WDR (1219+IMX290_2_INCREASE_LINES)
#define IMX290_2_VMAX_1080P120TO30_WDR (1125+IMX290_2_INCREASE_LINES)
...
#define IMX290_2_RES_IS_720P(w, h)       ((w) <= 1280 && (h) <= 720)
#define IMX290_2_RES_IS_1080P(w, h)      ((w) <= 1920 && (h) <= 1080)
#define IMX290_2_RES_IS_WDR(w, h)      ((w) <= 1952 && (h) <= 2678)

#define SENSOR_NM (0)


#if 0
static AR_S32 imx290_2_cmos_power_on(VI_PIPE ViPipe)
{
...
static AR_S32 imx290_2_cmos_power_off(VI_PIPE ViPipe)
{
    AR_U32 reset_val = 0, pow_val = 0, val = 0;
    AR_MPI_ISP_GetRegister(ViPipe, 0x07890004, &val);
...
static AR_S32 imx290_2_cmos_power_on(VI_PIPE ViPipe,ar_dev_power_attr_t  *p_dev_power_attr)
{
	...
	ar_always("imx290_2_cmos_power_on  power_gpio=%d reset_gpio=%d\n",power_gpio,reset_gpio);
...
static AR_S32 imx290_2_cmos_power_off(VI_PIPE ViPipe,ar_dev_power_attr_t  *p_dev_power_attr)
{
    int power_gpio=ar_hal_gpio_name_to_num(p_dev_power_attr->power_gpio[0],p_dev_power_attr->power_gpio[1],p_dev_power_attr->power_gpio[2]);
    int reset_gpio=ar_hal_gpio_name_to_num(p_dev_power_attr->reset_gpio[0],p_dev_power_attr->reset_gpio[1],p_dev_power_attr->reset_gpio[2]);
	...
	ar_always("imx290_2_cmos_power_off  power_gpio=%d reset_gpio=%d\n",power_gpio,reset_gpio);
	//set the gpio dir to out
	ar_hal_gpio_set_dir(power_gpio,1);
	ar_hal_gpio_set_dir(reset_gpio,1);
...
static AR_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    IMX290_2_SENSOR_GET_CTX(ViPipe, pstSnsState);
    CMOS_CHECK_POINTER(pstSnsState);
    pstAeSnsDft->f32Fps = g_astImx290ImageMode[ViPipe].f32Fps;
	pstAeSnsDft->f32MaxFps = (pstSnsState->u8ImgMode == IMX290_2_SENSOR_1080P_30FPS_LINEAR_MODE ? 30 : g_astImx290ImageMode[ViPipe].f32Fps);
    pstAeSnsDft->u32FullLinesStd = pstSnsState->u32FLStd;
    pstAeSnsDft->u32FlickerFreq = 50 * 256;
    pstAeSnsDft->u32FullLinesMax = IMX290_2_FULL_LINES_MAX;
...
{
    ISP_SNS_STATE_S *pstSnsState = AR_NULL;
    AR_U32 u32VMAX = IMX290_2_VMAX_1080P30_LINEAR;
    ...
    {
        case IMX290_2_SENSOR_1080P_30FPS_2t1_WDR_MODE:
            if ((f32Fps <= pstAeSnsDft->f32MaxFps) && (f32Fps >= 16.5))
            {
                u32VMAX = IMX290_2_VMAX_1080P30_WDR * pstAeSnsDft->f32MaxFps / DIV_0_TO_1_FLOAT(f32Fps);
            }
            else
            {
            ...
            u32VMAX = (u32VMAX > IMX290_2_FULL_LINES_MAX_2TO1_WDR) ? IMX290_2_FULL_LINES_MAX_2TO1_WDR : u32VMAX;
            break;

        case IMX290_2_SENSOR_1080P_30FPS_3t1_WDR_MODE:
            if ((f32Fps <= pstAeSnsDft->f32MaxFps) && (f32Fps >= 16.5))
            {
                u32VMAX = IMX290_2_VMAX_1080P120TO30_WDR * pstAeSnsDft->f32MaxFps / DIV_0_TO_1_FLOAT(f32Fps);
            }
            else
            {
                ISP_TRACE(AR_DBG_ERR, "Not support Fps: %f\n", f32Fps);
            ...
            u32VMAX = (u32VMAX > IMX290_2_FULL_LINES_MAX_3TO1_WDR) ? IMX290_2_FULL_LINES_MAX_3TO1_WDR : u32VMAX;
            break;

        case IMX290_2_SENSOR_1080P_30FPS_LINEAR_MODE:
            if ((f32Fps <= pstAeSnsDft->f32MaxFps) && (f32Fps >= 0.5))
            {
                u32VMAX = IMX290_2_VMAX_1080P30_LINEAR * pstAeSnsDft->f32MaxFps / DIV_0_TO_1_FLOAT(f32Fps);		// dg : 20220318
                //u32VMAX = IMX290_2_VMAX_1080P30_LINEAR * pstAeSnsDft->f32MaxFps / DIV_0_TO_1_FLOAT(f32Fps);
            }
            else
            {
                ISP_TRACE(AR_DBG_ERR, "Not support Fps: %f\n", f32Fps);
            ...
            u32VMAX = (u32VMAX > IMX290_2_FULL_LINES_MAX) ? IMX290_2_FULL_LINES_MAX : u32VMAX;
            break;

        case IMX290_2_SENSOR_1080P_60FPS_LINEAR_MODE:							// dg : 20220318
            if ((f32Fps <= pstAeSnsDft->f32MaxFps) && (f32Fps >= 0.5))
            {
                u32VMAX = IMX290_2_VMAX_1080P30_LINEAR * pstAeSnsDft->f32MaxFps / DIV_0_TO_1_FLOAT(f32Fps);
            }
        ...
        case IMX290_2_SENSOR_720P_30FPS_2t1_WDR_MODE:
            if ((f32Fps <= pstAeSnsDft->f32MaxFps) && (f32Fps >= 0.5))
            {
                u32VMAX = IMX290_2_VMAX_720P60TO30_WDR * pstAeSnsDft->f32MaxFps / DIV_0_TO_1_FLOAT(f32Fps);
            }
            else
            {
                ISP_TRACE(AR_DBG_ERR, "Not support Fps: %f\n", f32Fps);
    ...
    if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode)
    {
        ...
        /*
            ...
            2n + 5
            RHS1 <= FSC - BRL*2 -21
            (2 * VMAX_IMX290_2_1080P30_WDR - 2 * gu32BRL - 21) - (((2 * VMAX_IMX290_2_1080P30_WDR - 2 * 1109 - 21) - 5) %2)
        */

        g_astimx290_2State[ViPipe].u32RHS1_MAX = (u32VMAX - g_astimx290_2State[ViPipe].u32BRL) * 2 - 21;
    ...
    else if (WDR_MODE_3To1_LINE == pstSnsState->enWDRMode)
    {
        ...
        /*
            ...
            RHS2 <= FSC - BRL*3 -25
        */
        g_astimx290_2State[ViPipe].u32RHS2_MAX = u32VMAX * 4 - g_astimx290_2State[ViPipe].u32BRL * 3 - 25;
                                       ...
                                       AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode)
    {
        //u32FullLines = (u32FullLines > 2 * IMX290_2_FULL_LINES_MAX_2TO1_WDR) ? 2 * IMX290_2_FULL_LINES_MAX_2TO1_WDR : u32FullLines;
        //pstSnsState->au32FL[0] = (u32FullLines >> 1 ) << 1;
        //g_astimx290_2State[ViPipe].u32RHS1_MAX = pstSnsState->au32FL[0] - g_astimx290_2State[ViPipe].u32BRL * 2 - 21;
    }
    else if (WDR_MODE_3To1_LINE == pstSnsState->enWDRMode)
    {
        u32FullLines = (u32FullLines > 4 * IMX290_2_FULL_LINES_MAX_3TO1_WDR) ? 4 * IMX290_2_FULL_LINES_MAX_3TO1_WDR : u32FullLines;
        pstSnsState->au32FL[0] = (u32FullLines >> 2) << 2;
        g_astimx290_2State[ViPipe].u32RHS2_MAX = pstSnsState->au32FL[0] - g_astimx290_2State[ViPipe].u32BRL * 3 - 25;
    }
    else if ( WDR_MODE_2To1_FRAME == pstSnsState->enWDRMode)
    {
        u32FullLines = (u32FullLines > IMX290_2_FULL_LINES_MAX) ? IMX290_2_FULL_LINES_MAX : u32FullLines;
...
static AR_VOID cmos_inttime_update(VI_PIPE ViPipe, AR_U32 u32IntTime)
{
    ...
    if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode)
    {
        ...
        else   /* long exposure */
        {
            ...
            if (IMX290_2_SENSOR_1080P_30FPS_2t1_WDR_MODE == pstSnsState->u8ImgMode)
            {
...
static AR_VOID cmos_again_calc_table(VI_PIPE ViPipe, AR_U32 *pu32AgainLin, AR_U32 *pu32AgainDb)
{
    ...
    {
        g_astimx290_2State[ViPipe].u8Hcg |= 0x10;
        u32HCGOn = 1;
    }
...
{
    ISP_SNS_STATE_S *pstSnsState = AR_NULL;
    AR_U32 u32HCG = g_astimx290_2State[ViPipe].u8Hcg;
    AR_U32 u32Tmp;
    static AR_BOOL bFirst[ISP_MAX_PIPE_NUM] = {[0 ... (ISP_MAX_PIPE_NUM - 1)] = 1};
    IMX290_2_SENSOR_GET_CTX(ViPipe, pstSnsState);
    CMOS_CHECK_POINTER_VOID(pstSnsState);
    ...
    else if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode)
    {
        ...
        */
        ...
        else
        {
            ...
            u32IntTimeMaxTmp = (u32IntTimeMaxTmp0 < u32IntTimeMaxTmp) ? u32IntTimeMaxTmp0 : u32IntTimeMaxTmp;
            u32IntTimeMaxTmp = (u32IntTimeMaxTmp > (g_astimx290_2State[ViPipe].u32RHS1_MAX - 3)) ? (g_astimx290_2State[ViPipe].u32RHS1_MAX - 3) : u32IntTimeMaxTmp;
    ...
    else if (WDR_MODE_3To1_LINE == pstSnsState->enWDRMode)
    {
        ...
        */
        ...
        else
        {
            ...
            u32IntTimeMaxTmp = (u32IntTimeMaxTmp0 < u32IntTimeMaxTmp) ? u32IntTimeMaxTmp0 : u32IntTimeMaxTmp;
            u32RHS2_Max = ((g_astimx290_2State[ViPipe].u32RHS2_MAX - 8) * 0x40) / (au32Ratio[0] + 0x40);
...
static AR_S32 cmos_get_isp_default(VI_PIPE ViPipe, ISP_CMOS_DEFAULT_S *pstDef)
{
    ...
    pstDef->stSensorMode.u32SensorID = IMX290_2_ID;
    ...
    {
        default:
        case IMX290_2_SENSOR_1080P_60FPS_LINEAR_MODE:					// dg : right or not?		20220318
        case IMX290_2_SENSOR_1080P_30FPS_LINEAR_MODE:
        case IMX290_2_SENSOR_1080P_30FPS_3t1_WDR_MODE:
...
static AR_VOID cmos_set_pixel_detect(VI_PIPE ViPipe, AR_BOOL bEnable)
{
    ...
    {
        if (IMX290_2_SENSOR_1080P_30FPS_LINEAR_MODE == pstSnsState->u8ImgMode)
        {
            u32FullLines_5Fps = (IMX290_2_VMAX_1080P30_LINEAR * 30) / 5;
        }
        else if (IMX290_2_SENSOR_1080P_60FPS_LINEAR_MODE == pstSnsState->u8ImgMode)			// dg : right or not		20220318
        {
            u32FullLines_5Fps = (IMX290_2_VMAX_1080P30_LINEAR * 60) / 5;
        }
    ...
    //u32FullLines_5Fps = (u32FullLines_5Fps > IMX290_2_FULL_LINES_MAX) ? IMX290_2_FULL_LINES_MAX : u32FullLines_5Fps;
    u32MaxIntTime_5Fps = 4;

    if (bEnable) /* setup for ISP pixel calibration mode */
    {
        imx290_2_write_register (ViPipe, IMX290_2_GAIN_ADDR, 0x00);

        imx290_2_write_register (ViPipe, IMX290_2_VMAX_ADDR, u32FullLines_5Fps & 0xFF);
        imx290_2_write_register (ViPipe, IMX290_2_VMAX_ADDR + 1, (u32FullLines_5Fps & 0xFF00) >> 8);
        imx290_2_write_register (ViPipe, IMX290_2_VMAX_ADDR + 2, (u32FullLines_5Fps & 0xF0000) >> 16);

        imx290_2_write_register (ViPipe, IMX290_2_SHS1_ADDR, u32MaxIntTime_5Fps & 0xFF);
        imx290_2_write_register (ViPipe, IMX290_2_SHS1_ADDR + 1,  (u32MaxIntTime_5Fps & 0xFF00) >> 8);
        imx290_2_write_register (ViPipe, IMX290_2_SHS1_ADDR + 2, (u32MaxIntTime_5Fps & 0xF0000) >> 16);

    }
    else /* setup for ISP 'normal mode' */
    {
        pstSnsState->u32FLStd = (pstSnsState->u32FLStd > 0x1FFFF) ? 0x1FFFF : pstSnsState->u32FLStd;
        imx290_2_write_register (ViPipe, IMX290_2_VMAX_ADDR, pstSnsState->u32FLStd & 0xFF);
        imx290_2_write_register (ViPipe, IMX290_2_VMAX_ADDR + 1, (pstSnsState->u32FLStd & 0xFF00) >> 8);
        imx290_2_write_register (ViPipe, IMX290_2_VMAX_ADDR + 2, (pstSnsState->u32FLStd & 0xF0000) >> 16);
...
static AR_S32 cmos_get_sns_regs_info(VI_PIPE ViPipe, ISP_SNS_REGS_INFO_S *pstSnsRegsInfo)
{
    ...
    if ((AR_FALSE == pstSnsState->bSyncInit) || (AR_FALSE == pstSnsRegsInfo->bConfig))
    {
        ...
        pstSnsState->astRegsInfo[0].unComBus.s8I2cDev = g_aunImx290_2BusInfo[ViPipe].s8I2cDev;
        ...
        for (i = 0; i < pstSnsState->astRegsInfo[0].u32RegNum; i++)
        {
            ...
            pstSnsState->astRegsInfo[0].astI2cData[i].u8DevAddr = imx290_2_i2c_addr;
            pstSnsState->astRegsInfo[0].astI2cData[i].u32AddrByteNum = imx290_2_addr_byte;
            pstSnsState->astRegsInfo[0].astI2cData[i].u32DataByteNum = imx290_2_data_byte;
        }

        //Linear Mode Regs
        pstSnsState->astRegsInfo[0].astI2cData[0].u8DelayFrmNum = 0;
        pstSnsState->astRegsInfo[0].astI2cData[0].u32RegAddr = IMX290_2_SHS1_ADDR;
        pstSnsState->astRegsInfo[0].astI2cData[1].u8DelayFrmNum = 0;
        pstSnsState->astRegsInfo[0].astI2cData[1].u32RegAddr = IMX290_2_SHS1_ADDR + 1;
        pstSnsState->astRegsInfo[0].astI2cData[2].u8DelayFrmNum = 0;
        pstSnsState->astRegsInfo[0].astI2cData[2].u32RegAddr = IMX290_2_SHS1_ADDR + 2;

        pstSnsState->astRegsInfo[0].astI2cData[3].u8DelayFrmNum = 0;       //make shutter and gain effective at the same time
        pstSnsState->astRegsInfo[0].astI2cData[3].u32RegAddr = IMX290_2_GAIN_ADDR;  //gain
        pstSnsState->astRegsInfo[0].astI2cData[4].u8DelayFrmNum = 1;
        pstSnsState->astRegsInfo[0].astI2cData[4].u32RegAddr = IMX290_2_HCG_ADDR;

        pstSnsState->astRegsInfo[0].astI2cData[5].u8DelayFrmNum = 0;
        pstSnsState->astRegsInfo[0].astI2cData[5].u32RegAddr = IMX290_2_VMAX_ADDR;
        pstSnsState->astRegsInfo[0].astI2cData[6].u8DelayFrmNum = 0;
        pstSnsState->astRegsInfo[0].astI2cData[6].u32RegAddr = IMX290_2_VMAX_ADDR + 1;
        pstSnsState->astRegsInfo[0].astI2cData[7].u8DelayFrmNum = 0;
        pstSnsState->astRegsInfo[0].astI2cData[7].u32RegAddr = IMX290_2_VMAX_ADDR + 2;

        if ( WDR_MODE_2To1_FRAME == pstSnsState->enWDRMode)
        {
            pstSnsState->astRegsInfo[0].astI2cData[5].u8DelayFrmNum = 1;
            pstSnsState->astRegsInfo[0].astI2cData[5].u32RegAddr = IMX290_2_SHS1_ADDR;
            pstSnsState->astRegsInfo[0].astI2cData[6].u8DelayFrmNum = 1;
            pstSnsState->astRegsInfo[0].astI2cData[6].u32RegAddr = IMX290_2_SHS1_ADDR + 1;
            pstSnsState->astRegsInfo[0].astI2cData[7].u8DelayFrmNum = 1;
            pstSnsState->astRegsInfo[0].astI2cData[7].u32RegAddr = IMX290_2_SHS1_ADDR + 2;

            pstSnsState->astRegsInfo[0].astI2cData[8].u8DelayFrmNum = 0;
            pstSnsState->astRegsInfo[0].astI2cData[8].u32RegAddr = IMX290_2_VMAX_ADDR;
            pstSnsState->astRegsInfo[0].astI2cData[9].u8DelayFrmNum = 0;
            pstSnsState->astRegsInfo[0].astI2cData[9].u32RegAddr = IMX290_2_VMAX_ADDR + 1;
            pstSnsState->astRegsInfo[0].astI2cData[10].u8DelayFrmNum = 0;
            pstSnsState->astRegsInfo[0].astI2cData[10].u32RegAddr = IMX290_2_VMAX_ADDR + 2;
        ...
        else if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode)
        {
            ...
            pstSnsState->astRegsInfo[0].astI2cData[4].u32RegAddr = IMX290_2_SGAIN_ADDR;
            pstSnsState->astRegsInfo[0].astI2cData[5].u8DelayFrmNum = 1;
            pstSnsState->astRegsInfo[0].astI2cData[5].u32RegAddr = IMX290_2_HCG_ADDR;

            pstSnsState->astRegsInfo[0].astI2cData[6].u8DelayFrmNum = 0;
            pstSnsState->astRegsInfo[0].astI2cData[6].u32RegAddr = IMX290_2_SHS2_ADDR;
            pstSnsState->astRegsInfo[0].astI2cData[7].u8DelayFrmNum = 0;
            pstSnsState->astRegsInfo[0].astI2cData[7].u32RegAddr = IMX290_2_SHS2_ADDR + 1;
            pstSnsState->astRegsInfo[0].astI2cData[8].u8DelayFrmNum = 0;
            pstSnsState->astRegsInfo[0].astI2cData[8].u32RegAddr = IMX290_2_SHS2_ADDR + 2;

            pstSnsState->astRegsInfo[0].astI2cData[9].u8DelayFrmNum = 1;
            pstSnsState->astRegsInfo[0].astI2cData[9].u32RegAddr = IMX290_2_VMAX_ADDR;
            pstSnsState->astRegsInfo[0].astI2cData[10].u8DelayFrmNum = 1;
            pstSnsState->astRegsInfo[0].astI2cData[10].u32RegAddr = IMX290_2_VMAX_ADDR + 1;
            pstSnsState->astRegsInfo[0].astI2cData[11].u8DelayFrmNum = 1;
            pstSnsState->astRegsInfo[0].astI2cData[11].u32RegAddr = IMX290_2_VMAX_ADDR + 2;
        ...
        else if (WDR_MODE_3To1_LINE == pstSnsState->enWDRMode)
        {
            ...
            pstSnsState->astRegsInfo[0].astI2cData[5].u8DelayFrmNum = 0;
            pstSnsState->astRegsInfo[0].astI2cData[5].u32RegAddr = IMX290_2_SHS2_ADDR;
            pstSnsState->astRegsInfo[0].astI2cData[6].u8DelayFrmNum = 0;
            pstSnsState->astRegsInfo[0].astI2cData[6].u32RegAddr = IMX290_2_SHS2_ADDR + 1;
            pstSnsState->astRegsInfo[0].astI2cData[7].u8DelayFrmNum = 0;
            pstSnsState->astRegsInfo[0].astI2cData[7].u32RegAddr = IMX290_2_SHS2_ADDR + 2;
            ...
            pstSnsState->astRegsInfo[0].astI2cData[11].u8DelayFrmNum = 1;
            pstSnsState->astRegsInfo[0].astI2cData[11].u32RegAddr = IMX290_2_RHS1_ADDR;
            pstSnsState->astRegsInfo[0].astI2cData[12].u8DelayFrmNum = 1;
            pstSnsState->astRegsInfo[0].astI2cData[12].u32RegAddr = IMX290_2_RHS1_ADDR + 1;
            pstSnsState->astRegsInfo[0].astI2cData[13].u8DelayFrmNum = 1;
            pstSnsState->astRegsInfo[0].astI2cData[13].u32RegAddr = IMX290_2_RHS1_ADDR + 2;

            pstSnsState->astRegsInfo[0].astI2cData[14].u8DelayFrmNum = 1;
            pstSnsState->astRegsInfo[0].astI2cData[14].u32RegAddr = IMX290_2_RHS2_ADDR;
            pstSnsState->astRegsInfo[0].astI2cData[15].u8DelayFrmNum = 1;
            pstSnsState->astRegsInfo[0].astI2cData[15].u32RegAddr = IMX290_2_RHS2_ADDR + 1;
            pstSnsState->astRegsInfo[0].astI2cData[16].u8DelayFrmNum = 1;
            pstSnsState->astRegsInfo[0].astI2cData[16].u32RegAddr = IMX290_2_RHS2_ADDR + 2;

            pstSnsState->astRegsInfo[0].astI2cData[17].u8DelayFrmNum = 0;
            pstSnsState->astRegsInfo[0].astI2cData[17].u32RegAddr = IMX290_2_SHS3_ADDR;
            pstSnsState->astRegsInfo[0].astI2cData[18].u8DelayFrmNum = 0;
            pstSnsState->astRegsInfo[0].astI2cData[18].u32RegAddr = IMX290_2_SHS3_ADDR + 1;
            pstSnsState->astRegsInfo[0].astI2cData[19].u8DelayFrmNum = 0;
            pstSnsState->astRegsInfo[0].astI2cData[19].u32RegAddr = IMX290_2_SHS3_ADDR + 2;

            pstSnsState->astRegsInfo[0].astI2cData[20].u8DelayFrmNum = 1;
            pstSnsState->astRegsInfo[0].astI2cData[20].u32RegAddr = IMX290_2_Y_OUT_SIZE_ADDR;
            pstSnsState->astRegsInfo[0].astI2cData[21].u8DelayFrmNum = 1;
            pstSnsState->astRegsInfo[0].astI2cData[21].u32RegAddr = IMX290_2_Y_OUT_SIZE_ADDR + 1;
    ...
    if(pstSnsRegsInfo->bConfig) imx290_2_default_reg_init(ViPipe);
    return AR_SUCCESS;
}
...
static AR_S32 cmos_set_image_mode(VI_PIPE ViPipe, ISP_CMOS_SENSOR_IMAGE_MODE_S *pstSensorImageMode)
{
    ...
    if (pstSensorImageMode->f32Fps <= 30)
    {
        if (WDR_MODE_NONE == pstSnsState->enWDRMode)
        {
            g_astimx290_2State[ViPipe].u8Hcg = 0x2;

            if (IMX290_2_RES_IS_1080P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height))
            {
                u8SensorImageMode = IMX290_2_SENSOR_1080P_30FPS_LINEAR_MODE;
                pstSnsState->u32FLStd = IMX290_2_VMAX_1080P30_LINEAR;
            }
            else
            {
        ...
        {
            g_astimx290_2State[ViPipe].u8Hcg    = 0x1;

            if (IMX290_2_RES_IS_720P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height))
            {
                u8SensorImageMode = IMX290_2_SENSOR_720P_30FPS_2t1_WDR_MODE;
                pstSnsState->u32FLStd = IMX290_2_VMAX_720P60TO30_WDR * 2;
                g_astimx290_2State[ViPipe].u32BRL  = 735;
            }
            else if (IMX290_2_RES_IS_1080P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height))
            {
                u8SensorImageMode = IMX290_2_SENSOR_1080P_30FPS_2t1_WDR_MODE;
                pstSnsState->u32FLStd = IMX290_2_VMAX_1080P60TO30_WDR * 2;
                g_astimx290_2State[ViPipe].u32BRL = 1109;
            }
            else if (IMX290_2_RES_IS_WDR(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height))
            {
                u8SensorImageMode = IMX290_2_SENSOR_1080P_30FPS_2t1_WDR_MODE;
                pstSnsState->u32FLStd = IMX290_2_VMAX_1080P60TO30_WDR * 2 + 340;
                g_astimx290_2State[ViPipe].u32BRL = 1109;
            }
            else
            {
        ...
        {
            g_astimx290_2State[ViPipe].u8Hcg    = 0x0;

            if (IMX290_2_RES_IS_1080P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height))
            {
                u8SensorImageMode = IMX290_2_SENSOR_1080P_30FPS_3t1_WDR_MODE;
                pstSnsState->u32FLStd  = IMX290_2_VMAX_1080P120TO30_WDR * 4;
                g_astimx290_2State[ViPipe].u32BRL = 1109;
            }
            else
            {
    ...
    else
    {
        if (WDR_MODE_NONE == pstSnsState->enWDRMode)
        {
            ...
            if (IMX290_2_RES_IS_1080P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height))
            {
                u8SensorImageMode = IMX290_2_SENSOR_1080P_60FPS_LINEAR_MODE;
                pstSnsState->u32FLStd = IMX290_2_VMAX_1080P30_LINEAR;
            }
            else
            {
...
static AR_VOID sensor_global_init(VI_PIPE ViPipe)
{
    ...
    pstSnsState->bSyncInit = AR_FALSE;
    pstSnsState->u8ImgMode = IMX290_2_SENSOR_1080P_30FPS_LINEAR_MODE;
    pstSnsState->enWDRMode = WDR_MODE_NONE;
    pstSnsState->u32FLStd = IMX290_2_VMAX_1080P30_LINEAR;
    pstSnsState->au32FL[0] = IMX290_2_VMAX_1080P30_LINEAR;
    pstSnsState->au32FL[1] = IMX290_2_VMAX_1080P30_LINEAR;

    memset(&pstSnsState->astRegsInfo[0], 0, sizeof(ISP_SNS_REGS_INFO_S));
    memset(&pstSnsState->astRegsInfo[1], 0, sizeof(ISP_SNS_REGS_INFO_S));
}

static AR_S32 imx290_2_cmos_set_mirror_flip(VI_PIPE ViPipe, int mode)
{
    AR_S32 ret = 0;
    ...
    switch (mode)
    {
        case ISP_SNS_NORMAL:
        {
            ret = imx290_2_flip_off_mirro_off(ViPipe);
            break;
        }
        case ISP_SNS_MIRROR:
        {
            ret = imx290_2_flip_off_mirro_on(ViPipe);
            break;
        }
        case ISP_SNS_FLIP:
        {
            ret = imx290_2_flip_on_mirro_off(ViPipe);
            break;
        }
        case ISP_SNS_MIRROR_FLIP:
        {
            ret = imx290_2_flip_on_mirro_on(ViPipe);
            break;
        }
...
static AR_S32 imx290_2_cmos_sensor_ctl(VI_PIPE ViPipe, ISP_CMOS_SENSOR_CTL *pSensorCtl)
{
    if (!pSensorCtl)
    {
    ...
    switch(u8CtlCode)
    {
        ...
        {
            ret = imx290_2_cmos_set_mirror_flip(ViPipe, mode);
            break;
        }
        default:
...
static AR_S32 cmos_init_sensor_exp_function(ISP_SENSOR_EXP_FUNC_S *pstSensorExpFunc)
{
    ...
    pstSensorExpFunc->pfn_cmos_sensor_init = imx290_2_init;
    pstSensorExpFunc->pfn_cmos_sensor_exit = imx290_2_exit;
    ...
    pstSensorExpFunc->pfn_cmos_sns_power_on = imx290_2_cmos_power_on;
    pstSensorExpFunc->pfn_cmos_sns_power_off = imx290_2_cmos_power_off;
    pstSensorExpFunc->pfn_cmos_sns_ctl = imx290_2_cmos_sensor_ctl;
    return AR_SUCCESS;
}
...
static AR_S32 imx290_2_set_bus_info(VI_PIPE ViPipe, ISP_SNS_COMMBUS_U unSNSBusInfo)
{
    g_aunImx290_2BusInfo[ViPipe].s8I2cDev = unSNSBusInfo.s8I2cDev;
...
static AR_S32 sensor_ctx_init(VI_PIPE ViPipe)
{
    ...
    IMX290_2_SENSOR_GET_CTX(ViPipe, pastSnsStateCtx);
    ...
    IMX290_2_SENSOR_SET_CTX(ViPipe, pastSnsStateCtx);
...
static AR_VOID sensor_ctx_exit(VI_PIPE ViPipe)
{
    ...
    IMX290_2_SENSOR_RESET_CTX(ViPipe);
}
...
static AR_S32 sensor_register_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
    ...
    stSnsAttrInfo.eSensorId = IMX290_2_ID;
...
static AR_S32 sensor_unregister_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
    ...
    s32Ret = AR_MPI_ISP_SensorUnRegCallBack(ViPipe, IMX290_2_ID);
    if (AR_SUCCESS != s32Ret)
    {
    ...
    s32Ret = AR_MPI_AE_SensorUnRegCallBack(ViPipe, pstAeLib, IMX290_2_ID);
    if (AR_SUCCESS != s32Ret)
    {
    ...
    s32Ret = AR_MPI_AWB_SensorUnRegCallBack(ViPipe, pstAwbLib, IMX290_2_ID);
    if (AR_SUCCESS != s32Ret)
    {
...
ISP_SNS_OBJ_S stSnsImx290Obj2 =
{
    .pfnRegisterCallback    = sensor_register_callback,
    .pfnUnRegisterCallback  = sensor_unregister_callback,
    .pfnStandby             = imx290_2_standby,
    .pfnRestart             = imx290_2_restart,
    .pfnMirrorFlip          = AR_NULL,
    .pfnWriteReg            = imx290_2_write_register,
    .pfnReadReg             = imx290_2_read_register,
    .pfnSetBusInfo          = imx290_2_set_bus_info,
