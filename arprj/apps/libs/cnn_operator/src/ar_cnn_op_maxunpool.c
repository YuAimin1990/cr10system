...
AR_S32 AR_CNN_OperatorMaxUnPool(AR_UINTPTR pIn, AR_UINTPTR pOut, AR_NPU_CB_PARAM_S * pCBParams, void * pOpParams)
{
    ...
    AR_UINTPTR pConv = pIn + pCBParams->astInputTensor[1].u32Bank * 0x2000000 + pCBParams->astInputTensor[1].u32Offset;
    ...
    AR_UINTPTR pPool = pIn + pCBParams->astInputTensor[0].u32Bank * 0x2000000 + pCBParams->astInputTensor[0].u32Offset;
