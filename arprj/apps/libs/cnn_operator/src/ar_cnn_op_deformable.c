...
AR_S32 AR_CNN_OperatorDeformable(AR_UINTPTR pIn, AR_UINTPTR pOut, AR_NPU_CB_PARAM_S * pCBParams, void * pOpParams)
{
    ...
    AR_UINTPTR pOffset = pIn + pCBParams->astInputTensor[1].u32Bank * 0x2000000 + pCBParams->astInputTensor[1].u32Offset;
    ...
    AR_UINTPTR pMask = pIn + pCBParams->astInputTensor[2].u32Bank * 0x2000000 + pCBParams->astInputTensor[2].u32Offset;
