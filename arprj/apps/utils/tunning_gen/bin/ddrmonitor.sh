...
#2 trigger on 
set_reg_bits  0x06020000  0x10020   0  31
set_reg_bits  0x06030000  0         0  31
set_reg_bits  0x06040000  0         0  31
set_reg_bits  0x06050000  0         0  31

set_reg_bits  0x06020000  0x10021   0  31
set_reg_bits  0x06030000  1         0  31
set_reg_bits  0x06040000  1         0  31
set_reg_bits  0x06050000  1         0  31

#./arcnndemo 0.json &
#dd if=/dev/zero of=/tmp/test.bin  bs=20 count=1M &

/mnt/test
 
#3 trigger during waitting 

texp=$(expr "$1" \* "1000")    
usleep $texp

echo "[tigger over] dump_result start:============================"
dump_result $1
echo "[tigger over] dump_result stop:============================"
