...
CFLAGS  += -g  -rdynamic -funwind-tables -ffunction-sections -Wall -Wno-attributes
#$(KERNEL_EXTRA_CFLAG) -I$(TARGET_STAGING_INC) -I$(TARGET_STAGING_USR_INC)
...
CXXFLAGS  += -g -Wall
ifeq ($(CONFIG_BIT), 32bits)
	CXXFLAGS += -mfpu=neon-vfpv4 -mfloat-abi=hard -std=c++11
endif
...
ifneq ($(PROGRAM),)
	@$(RM) $(OUTPUT_APPLICATION_BIN_DIR)/$(PROGRAM)
endif
ifneq ("$(SHARED_LIBRARY)","")
