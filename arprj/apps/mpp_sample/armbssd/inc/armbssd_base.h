#ifndef __ARMBSSD_BASE_H__
#define __ARMBSSD_BASE_H__
...
#define AR_MBSSD_IMG_WIDTH 300
#define AR_MBSSD_IMG_HEIGHT 300
...
public:
    ...
    AR_S32 FillInputBuff(AR_IMG_S *stImg, AR_CHAR * pchFileName, AR_U32 u32InputId, AR_U32 u32BatchId);
