...
#define ARDEEPLAB_NetW 513
#define ARDEEPLAB_NetH 513
...
public:
	...
	AR_S32 PushLiveImage(AR_IMG_S * pstImg);
    //_S32 DeBindVideoDev();
...
private:
	...
	AR_U32 u32NetOutWidth;
	AR_U32 u32NetOutHeight;
	AR_U32 u32aChnInitValue;
	AR_FLOAT f32Threshold;
	//AR_S8 s8Threshold;
	...
	AR_CHAR* fileOrgBuff;
	AR_CHAR* fileOrgBuff1;
	AR_CHAR* fileOrgBuff2;
	AR_CHAR* imgDataBuff;

	AR_MEM_S resizeInbuff;
	AR_MEM_S resizeOutbuff;
	AR_MEM_S argbBuff;
	AR_MEM_S osdBuff;
	AR_MEM_S classBuff;
	AR_MEM_S SrcRgbBuff;
	
	AR_U32   u32resizeInStride;
	AR_U32 	 u32resizeOutStride;
	AR_U32   u32ResizeInSize;
	AR_U32   u32ResizeOutSize;
	AR_U32   u32argbSize;
	AR_U32   u32classSize;
	AR_U32   u32yStride;
	AR_U32   u32SrcRgbStride;
	AR_U32   u32SrcRgbSize;
	AR_U32   u32DstRgbStride;
	AR_U32   u32DstRgbSize;
	AR_U32   u32FollowImgSize;

	AR_IMG_S resizeInImg;
	AR_IMG_S resizeOutImg;
	AR_IMG_S CvtRgbImg;
