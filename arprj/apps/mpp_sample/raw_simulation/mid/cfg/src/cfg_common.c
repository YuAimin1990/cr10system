...
static CFG_RUN_MODE_E g_cfg_run_mode = 0;
...
void CfgSetRunMode(CFG_RUN_MODE_E enMode)
{
    g_cfg_run_mode = enMode;
}

CFG_RUN_MODE_E CfgGetRunMode(void)
{
    return g_cfg_run_mode;
}
