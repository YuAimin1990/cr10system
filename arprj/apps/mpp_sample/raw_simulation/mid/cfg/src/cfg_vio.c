...
CFG_MAP ViMap[IPC_MAX_PIPELINE_NUM][50] =
{
    //sensor 0
    {
        {"mipi_id",  &(g_stRunVioCfg.vi[0].mipi_id),   CFG_DATA_TYPE_U32, "0", "rw", 0, 8,  "sensor mipi_id"},
        {"sensor",  &(g_stRunVioCfg.vi[0].sensor),   CFG_DATA_TYPE_STRING, "raw_simu", "rw", 1, 32,  "sensor name: null means no sensor"},
        {"isp.wnd.x",   &(g_stRunVioCfg.vi[0].stPubAttr.stWndRect.s32X), CFG_DATA_TYPE_U32, "0",  "rw", 0, 4096,  NULL},        
        {"isp.wnd.y",   &(g_stRunVioCfg.vi[0].stPubAttr.stWndRect.s32Y), CFG_DATA_TYPE_U32, "0",  "rw", 0, 4096,  NULL},        
        {"isp.wnd.w",   &(g_stRunVioCfg.vi[0].stPubAttr.stWndRect.u32Width), CFG_DATA_TYPE_U32, "1920",  "rw", 0, 4096,  NULL},        
        {"isp.wnd.h",   &(g_stRunVioCfg.vi[0].stPubAttr.stWndRect.u32Height), CFG_DATA_TYPE_U32, "1080",  "rw", 0, 4096,  NULL},        
        {"isp.sns.w",   &(g_stRunVioCfg.vi[0].stPubAttr.stSnsSize.u32Width), CFG_DATA_TYPE_U32, "1920",  "rw", 0, 4096,  NULL},        
        {"isp.sns.h",   &(g_stRunVioCfg.vi[0].stPubAttr.stSnsSize.u32Height), CFG_DATA_TYPE_U32, "1080",  "rw", 0, 4096,  NULL},        
        {"isp.bayerfmt",   &(g_stRunVioCfg.vi[0].stPubAttr.enBayer), CFG_DATA_TYPE_U32, "0",  "rw", 0, 4,  "0: RGGB, 1: GRBG, 2: GBRG, 3: BGGR"},        
        {"combo.rect.x",   &(g_stRunVioCfg.vi[0].stComboAttr.stRect.s32X), CFG_DATA_TYPE_U32, "0",  "rw", 0, 4096,  NULL},        
        {"combo.rect.y",   &(g_stRunVioCfg.vi[0].stComboAttr.stRect.s32Y), CFG_DATA_TYPE_U32, "0",  "rw", 0, 4096,  NULL},
        {"combo.rect.w",   &(g_stRunVioCfg.vi[0].stComboAttr.stRect.u32Width), CFG_DATA_TYPE_U32, "1920",  "rw", 0, 4096,  NULL},
        {"combo.rect.h",   &(g_stRunVioCfg.vi[0].stComboAttr.stRect.u32Height), CFG_DATA_TYPE_U32, "1080",  "rw", 0, 4096,  NULL},
        {"combo.datatype",   &(g_stRunVioCfg.vi[0].stComboAttr.enMipiDataType), CFG_DATA_TYPE_U32, "2",  "rw", 0, 8,  "0:8bit,1:10bit,2:12bit,3:14bit,4:16bit"},
        {"dev.width",   &(g_stRunVioCfg.vi[0].stDevAttr.u32Width), CFG_DATA_TYPE_U32, "1920",  "rw", 0, 4096,  NULL},
        {"dev.height",   &(g_stRunVioCfg.vi[0].stDevAttr.u32Height), CFG_DATA_TYPE_U32, "1080",  "rw", 0, 4096,  NULL},
        {"dev.scale.width",   &(g_stRunVioCfg.vi[0].stDevAttr.u32BayerScaleWidth), CFG_DATA_TYPE_U32, "1920",  "rw", 0, 4096,  NULL},
        {"dev.scale.height",   &(g_stRunVioCfg.vi[0].stDevAttr.u32BayerScaleHeight), CFG_DATA_TYPE_U32, "1080",  "rw", 0, 4096,  NULL},
        {"pipe.width",   &(g_stRunVioCfg.vi[0].stPipeAttr.u32MaxW), CFG_DATA_TYPE_U32, "1920",  "rw", 0, 4096,  NULL},
        {"pipe.height",   &(g_stRunVioCfg.vi[0].stPipeAttr.u32MaxH), CFG_DATA_TYPE_U32, "1080",  "rw", 0, 4096,  NULL},
        {"pipe.pixfmt",   &(g_stRunVioCfg.vi[0].stPipeAttr.enPixFmt), CFG_DATA_TYPE_U32, "19",  "rw", 0, 64,  NULL},
        {"pipe.bitwidth",   &(g_stRunVioCfg.vi[0].stPipeAttr.enBitWidth), CFG_DATA_TYPE_U32, "12",  "rw", 8, 18,  NULL},
        {"pipe.nr.pixfmt",   &(g_stRunVioCfg.vi[0].stPipeAttr.enNrPixFmt), CFG_DATA_TYPE_U32, "23",  "rw", 0, 64,  NULL},
        {"pipe.nr.bitwidth",   &(g_stRunVioCfg.vi[0].stPipeAttr.enNrBitWidth), CFG_DATA_TYPE_U32, "8",  "rw", 8, 18,  NULL},
        {"pipe.nr.compressmode",   &(g_stRunVioCfg.vi[0].stPipeAttr.enNrCompressMode), CFG_DATA_TYPE_U32, "2",  "rw", 0, 4,  NULL},
        {"chn.width",   &(g_stRunVioCfg.vi[0].stChnAttr.stSize.u32Width), CFG_DATA_TYPE_U32, "1920",  "rw", 0, 4096,  NULL},
        {"chn.height",   &(g_stRunVioCfg.vi[0].stChnAttr.stSize.u32Height), CFG_DATA_TYPE_U32, "1080",  "rw", 0, 4096,  NULL},
        {"chn.pixfmt",   &(g_stRunVioCfg.vi[0].stChnAttr.enPixelFormat), CFG_DATA_TYPE_U32, "23",  "rw", 0, 64,  NULL},

        {"channel_1_enable",   &(g_stRunVioCfg.vi[0].channel_1_enable), CFG_DATA_TYPE_U32, "0",  "rw", 0, 4096,  NULL},
        ...
        {"fps",   &(g_stRunVioCfg.vi[0].fps), CFG_DATA_TYPE_U32, "30",  "rw", 0, 60,  NULL},
...
CFG_MAP ViCfgMap[] =
{
    {"cam_mode",  &(g_stRunVioCfg.vi_cfg.cam_mode),   CFG_DATA_TYPE_U32, "3", "rw", 0, 4,  NULL},
    {"vb_blk_cnt",  &(g_stRunVioCfg.vi_cfg.vb_blk_cnt),   CFG_DATA_TYPE_U32, "5", "rw", 0, 20,  NULL},
...
#endif
static void IPC_CFG_VIO_SetRawSimu()
{
    IPC_CFG_VIO_S * pVioCfg = IPC_CFG_VIO_GetParam();

    strcpy(pVioCfg->vi[0].sensor, "raw_simu");    
    pVioCfg->vi[0].channel_1_enable = 0;
    pVioCfg->vi[0].channel_2_raw_enable = 0;
...
AR_S32 IPC_CFG_VIO_LoadDefault(CFG_RUN_MODE_E enMode)
{
    ...
    switch(enMode)
    {
        case CFG_RUN_MODE_ISP_RAW_SIMU:
            IPC_CFG_VIO_SetRawSimu();
            break;
#if 0
