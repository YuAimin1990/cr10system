...
AR_U32 nms_proc(candidate_Result *canResult, AR_U32 u32NumCan, detector_Result *detResult, yolov8_Param& param)
{
	AR_FLOAT iou = 0.0;
	AR_U32 u32KeepNum = 0;
	...
	for(AR_U32 i = 0; i < u32NumCan; i++)
	{
		...
		detResult[u32KeepNum].clsId = canResult[i].u32Cls;
		...
		detResult[u32KeepNum].score = canResult[i].conf;
		u32KeepNum++;
...
*/
AR_U32 yolov8_postprocess(void *handle, AR_CHAR *npuOutBuff, yolov8_Param& yoloParam, detector_Result *detResult, candidate_Result *canResult, AR_U32 *tensorsId)
{
	AR_U32 u32NumCan 	= 0;
	AR_U32 u32ObjNum 	= 0;
	...
	u32ObjNum = nms_proc(canResult, u32NumCan, detResult, yoloParam);
