...
public:
	...
	AR_S32 GetLocalInput(AR_CHAR * pchFileName, AR_IMG_SET_S *stImg, AR_U32 u32InputId, AR_U32 u32BatchId, AR_U32 u32FrameId);
    ...
    AR_U32 GetBatchNum();
	AR_U32 GetFrameNum();
	AR_U32 GetYUVStep(AR_U32 u32Index);
	AR_U32 GetBatchTensorStep(AR_U32 u32Index);
