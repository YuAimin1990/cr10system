...
#include "gst612c/gst612c.h"


static AR_S32 Gst612cRawProcess(IR_SAMPLE_CTX_S *pstIrSampleCtx, VIDEO_FRAME_INFO_S *pstFrmInfo);
static AR_S32 Gst612cCfgIrViTopology(IR_SAMPLE_CTX_S *pstIrSampleCtx,
    IR_VI_TOPOLOGY_TYPE_E enIrViTopoType, AR_U32 u32Width, AR_U32 u32Height);
static AR_S32 Gst612cIrCmdGetIrSnsParam(IR_SAMPLE_CTX_S *pstIrSampleCtx);


IR_SAMPLE_CTX_S stGst612cIrSampleCtx = {
    .stIrViGrpCfg = {
        .aViDev = {0, 1, 2, 3, 4},
        .aViPipe = {0, 1, 2, 3, 4},
        .aViChn = {0, 2, 4, 0, 0},
        .aenSnsType = {
            ...
            GST612C_IR_640X520,                     // ir raw
            ISP_VIN_IR_THERMAL_GST612C,             // ir thermal
            ISP_VIN1_IR_GST612C,                    // ir isp1
            ISP_VIN2_IR_GST612C,                    // ir isp2
        },
        .aenInPixFmt = {
    ...
    .strInitSnsParamCalibFname = "/usrdata/local/factory/tunning/cam_gst612c/gst612c_sns_calib.bin",
    .strInitOccCalibFname = "/usrdata/local/factory/tunning/cam_gst612c/gst612c_occ_calib.bin",
    .strInitKbCalibFname = "/usrdata/local/factory/tunning/cam_gst612c/gst612c_kb_calib.bin",
    ...
    .pfnRawProcess = Gst612cRawProcess,
    .pfnCfgIrViTopology = Gst612cCfgIrViTopology,
    .pfnIrCmdGetIrSnsParam = Gst612cIrCmdGetIrSnsParam,
};
    ...
    IR_VI_TOPOLOGY_TYPE_E enIrViTopoType, AR_U32 u32Width, AR_U32 u32Height)
{
    ...
    case IR_VI_TOPOLOGY_TYPE_0:     // ir_raw --> ir_thermal --> ir_isp1 --> ir_isp2
        ...
        pstIrViGrpCfg->aenSnsType[pstIrViGrpCfg->s32IrIsp1Idx] = ISP_VIN1_IR_GST612C;
        break;
    ...
    case IR_VI_TOPOLOGY_TYPE_1:     // ir_raw --> (ir_isp1 & ir_thermal) --> ir_isp2
        ...
        pstIrViGrpCfg->s32IrIsp1Idx = 3;
        pstIrViGrpCfg->s32IrIsp2Idx = 4;
        pstIrViGrpCfg->aenSnsType[pstIrViGrpCfg->s32IrIsp1Idx] = ISP_VIN1_IR_GST612C_WITH_THERMAL;
        pstIrViGrpCfg->aenInPixFmt[pstIrViGrpCfg->s32IrIsp1Idx] = PIXEL_FORMAT_RGB_BAYER_14BPP;
        pstIrViGrpCfg->astInSize[pstIrViGrpCfg->s32IrIsp1Idx].u32Width = 640;
        pstIrViGrpCfg->astInSize[pstIrViGrpCfg->s32IrIsp1Idx].u32Height = 520;
        break;
...
static AR_S32 Gst612cIrCmdGetIrSnsParam(IR_SAMPLE_CTX_S *pstIrSampleCtx)
{
    ...
    if (s32Ret) {
        ar_err("get gst612c ir sns param failed");
        return -1;
    }

    printf("get gst612w ir sns param successfully, ra_sel[0x%02x] hssd[0x%02x]\n",
