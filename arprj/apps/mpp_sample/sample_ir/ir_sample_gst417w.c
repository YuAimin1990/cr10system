...
static AR_S32 Gst417wRawProcess(IR_SAMPLE_CTX_S *pstIrSampleCtx, VIDEO_FRAME_INFO_S *pstFrmInfo);
static AR_S32 Gst417wCfgIrViTopology(IR_SAMPLE_CTX_S *pstIrSampleCtx,
    IR_VI_TOPOLOGY_TYPE_E enIrViTopoType, AR_U32 u32Width, AR_U32 u32Height);
static AR_S32 Gst417wIrCmdGetIrSnsParam(IR_SAMPLE_CTX_S *pstIrSampleCtx);


IR_SAMPLE_CTX_S stGst417wIrSampleCtx = {
    .stIrViGrpCfg = {
        .aViDev = {0, 1, 2, 3, 4},
        .aViPipe = {0, 1, 2, 3, 4},
        .aViChn = {0, 2, 4, 0, 0},
    ...
    .pfnRawProcess = Gst417wRawProcess,
    .pfnCfgIrViTopology = Gst417wCfgIrViTopology,
    .pfnIrCmdGetIrSnsParam = Gst417wIrCmdGetIrSnsParam,
};
...
static AR_S32 Gst417wIrCmdGetIrSnsParam(IR_SAMPLE_CTX_S *pstIrSampleCtx)
{
    ...
    stIrParams.astParamEntry[0].u32ParamSize = 6;
    ...
    printf("get gst417w ir sns param successfully, ra_adj[0x%02x%02x%02x%02x%02x] hssd[0x%02x]\n",
        au8IrSnsParam[4], au8IrSnsParam[3], au8IrSnsParam[2], au8IrSnsParam[1],
        au8IrSnsParam[0], au8IrSnsParam[5]);
