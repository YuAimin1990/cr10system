...
#define TEST_VDEC_MAX_CHN_NUM      32
...
typedef enum arSAMPLE_SNS_TYPE_E
{
    ...
    TP9930_DVP_SINGLE_CH,               // 1ch bt656
    TP9930_DVP_MULTIPLEX_2CH,           // 2ch bt656
    TP9930_DVP_MULTIPLEX_4CH,           // 4ch bt1120
    TP9930_DVP_MULTIPLEX_4CH_BT656,     // 4ch bt656
    SONY_IMX307_MIPI_2M_25FPS_12BIT,
    SONY_IMX464_MIPI_4M_30FPS_12BIT_WDR2TO1,
	SONY_IMX464_MIPI_4M_30FPS_12BIT_WDR2TO1_VC_RAW,
    ...
    GC_GC2093_MIPI_1080P_30FPS_10BIT,
    GC_GC2093_MIPI_1080P_30FPS_10BIT_WDR2TO1,
    SC_SC530AI_MIPI_5M_30FPS_10BIT,
    SONY_IMX290_MIPI_2M_60FPS_12BIT,
    ISP_VIN_0_MEM_2M_30FPS_12BIT_BIG_PIC,
    ISP_VIN_0_MEM_48M_5FPS_12BIT_BIG_PIC,
	IRAY_PAL_DVP_SINGLE_CH,
    OV_OV48C40_MIPI_48M_5FPS_12BIT_BIG_PIC,
    SONY_IMX290_MIPI_2M_30FPS_12BIT_BIG_PIC,
    SONY_IMX290_MIPI_2M_30FPS_12BIT_WDR2TO1_BIG_PIC,
    ISP_VIN_0_MEM_2M_30FPS_12BIT_WDR2TO1_LINE_BIG_PIC,
    ISP_VIN_0_MEM_2M_30FPS_12BIT_WDR2TO1_LINE_BIG_PIC_R,
	SONY_IMX347_MIPI_4M_25FPS_12BIT,
	SONY_IMX415_MIPI_HIGH_SPEED_12BIT,
	SONY_IMX415_MIPI_WDR2TO1_VC_12BIT,
    GST417W_IR_400X308,                     // gst417w ir_raw
    ISP_VIN_IR_THERMAL_GST417W,             // gst417w ir_thermal
    ISP_VIN1_IR_GST417W,                    // gst417w ir_isp1
    ISP_VIN1_IR_GST417W_WITH_THERMAL,       // gst417w ir_isp1 and ir_thermal (share one device)
    ISP_VIN2_IR_GST417W,                    // gst417w ir_isp2
    H3812C1SG_IR_444X336,                   // h3812c1sg ir_raw
    ISP_VIN_IR_THERMAL_H3812C1SG,           // h3812c1sg ir_thermal
    ISP_VIN1_IR_H3812C1SG,                  // h3812c1sg ir_isp1
    ISP_VIN1_IR_H3812C1SG_WITH_THERMAL,     // h3812c1sg ir_isp1 and ir_thermal (share one device)
    ISP_VIN2_IR_H3812C1SG,                  // h3812c1sg ir_isp2
    RTD6122C_IR_656X522,                    // rtd6122c ir_raw
    ISP_VIN_IR_THERMAL_RTD6122C,            // rtd6122c ir_thermal
    ISP_VIN1_IR_RTD6122C,                   // rtd6122c ir_isp1
    ISP_VIN1_IR_RTD6122C_WITH_THERMAL,      // rtd6122c ir_isp1 and ir_thermal (share one device)
    ISP_VIN2_IR_RTD6122C,                   // rtd6122c ir_isp2
    RTD3172C_IR_394X298,                    // rtd3172c ir_raw
    ISP_VIN_IR_THERMAL_RTD3172C,            // rtd3172c ir_thermal
    ISP_VIN1_IR_RTD3172C,                   // rtd3172c ir_isp1
    ISP_VIN1_IR_RTD3172C_WITH_THERMAL,      // rtd3172c ir_isp1 and ir_thermal (share one device)
    ISP_VIN2_IR_RTD3172C,                   // rtd3172c ir_isp2
    GST412C_IR_400X308,                     // gst412c ir_raw
    GST612C_IR_640X520,                     // gst612c ir_raw
    ISP_VIN_IR_THERMAL_GST612C,             // gst612c ir_thermal
    ISP_VIN1_IR_GST612C,                    // gst612c ir_isp1
    ISP_VIN1_IR_GST612C_WITH_THERMAL,       // gst612c ir_isp1 and ir_thermal (share one device)
    ISP_VIN2_IR_GST612C,                    // gst612c ir_isp2
    SC_SC2210_1080P,
    GST212W4_IR_256X200,                    // gst212w4 ir_raw
    ISP_VIN_IR_THERMAL_GST212W4,            // gst212w4 ir_thermal
    ISP_VIN1_IR_GST212W4,                   // gst212w4 ir_isp1
    ISP_VIN1_IR_GST212W4_WITH_THERMAL,      // gst212w4 ir_isp1 and ir_thermal (share one device)
    ISP_VIN2_IR_GST212W4,                   // gst212w4 ir_isp2
    ISP_VIN_IR_THERMAL_OFFLINE,             // offline ir_thermal
    ISP_VIN1_IR_OFFLINE,                    // offline ir_isp1
    ISP_VIN1_IR_OFFLINE_WITH_THERMAL,       // offline ir_isp1 and ir_thermal (share one device)
    ISP_VIN2_IR_OFFLINE,                    // offline ir_isp2
    OV_OS05A20_2688x1944,
    OV_OS05A20_2336x1752,
	OB_PLECO_MIPI_1920x2880_30FPS_10BIT,
	SONY_IMX290_MIPI_2M_30FPS_12BIT_VC_RAW,
	GC_GC2053_MIPI_1080P_30FPS_10BIT,
    SAMSUNG_S5KGN2SP_MIPI_4K_60FPS_10BIT,
    SAMSUNG_S5KGN2SP_MIPI_4K_30FPS_10BIT,
    SAMSUNG_S5KGN2SP_MIPI_2K7_60FPS_10BIT,
