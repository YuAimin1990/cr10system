...
bool h265_has_start_code(const uint8_t *buf);
int  h265_find_nal_unit(uint8_t* buf, int size, int* nal_start, int* nal_end);

int  h265_rbsp_to_nal(const uint8_t* rbsp_buf, const int* rbsp_size, uint8_t* nal_buf, int* nal_size);
int  h265_nal_to_rbsp(const uint8_t* nal_buf, int* nal_size, uint8_t* rbsp_buf, int* rbsp_size);

int  h265_read_nal_unit(h265_stream_t* h, uint8_t* buf, int size);
void h265_read_video_parameter_set_rbsp(h265_stream_t* h, bs_t* b);
void h265_read_seq_parameter_set_rbsp(h265_stream_t* h, bs_t* b);
void h265_read_st_ref_pic_set(h265_stream_t* h, bs_t* b,int  stRpsIdx);
void h265_read_ref_pic_lists_modification(h265_stream_t* h, bs_t* b);
void h265_read_profile_tier_level(h265_stream_t* h, bs_t* b,int profilePresentFlag,int maxNumSubLayersMinus1);
void h265_read_scaling_list_data(h265_stream_t* h, bs_t* b);
void h265_read_vui_parameters(h265_stream_t* h, bs_t* b);
void h265_read_hrd_parameters(h265_stream_t* h, bs_t* b);
void h265_read_pic_parameter_set_rbsp(h265_stream_t* h, bs_t* b);
void h265_read_access_unit_delimiter_rbsp(h265_stream_t* h, bs_t* b);
void h265_read_scaling_list_data(h265_stream_t* h, bs_t* b);
void h265_read_slice_segment_header(h265_stream_t* h, bs_t* b);
void h265_read_slice_rbsp(h265_stream_t* h, bs_t* b);

void h265_read_rbsp_trailing_bits(h265_stream_t* h, bs_t* b);
void h265_read_rbsp_trailing_bits(h265_stream_t* h, bs_t* b);
int  h265_more_rbsp_trailing_data(h265_stream_t* h, bs_t* b);

int  h265_check_and_revise_nal_header(h265_stream_t* h, uint8_t* buf, int size);
void h265_printVPS(h265_stream_t* h);
void h265_printSPS(h265_stream_t* h);
void h265_printPPS(h265_stream_t* h);
void h265_printPTL(h265_stream_t* h);
void h265_printSH(h265_stream_t* h);
...
#define H265_SH_SLICE_TYPE_B        0        // B (B slice)
#define H265_SH_SLICE_TYPE_P        1        // P (P slice)
...
#define H265_SAR_4_3       14
#define H265_SAR_3_2       15
#define H265_SAR_2_1       16
                                     // 17..254           Reserved
