...
bool h264_has_start_code(const uint8_t *buf);
...
void h264_read_seq_parameter_set_rbsp(sps_t* sps, bs_t* b);
void h264_read_scaling_list(bs_t* b, int* scalingList, int sizeOfScalingList, int* useDefaultScalingMatrixFlag );
void h264_read_vui_parameters(sps_t* sps, bs_t* b);
void h264_read_hrd_parameters(hrd_t* hrd, bs_t* b);
...
void h264_read_rbsp_trailing_bits(bs_t* b);
...
void h264_write_seq_parameter_set_rbsp(sps_t* sps, bs_t* b);
void h264_write_scaling_list(bs_t* b, int* scalingList, int sizeOfScalingList, int* useDefaultScalingMatrixFlag );
void h264_write_vui_parameters(sps_t* sps, bs_t* b);
void h264_write_hrd_parameters(hrd_t* hrd, bs_t* b);
...
void h264_write_rbsp_trailing_bits(bs_t* b);
...
int  h264_read_debug_nal_unit(h264_stream_t* h, uint8_t* buf, int size);
...
void h264_read_sei_payload( h264_stream_t* h, bs_t* b);
void h264_read_debug_sei_payload( h264_stream_t* h, bs_t* b);
void h264_write_sei_payload( h264_stream_t* h, bs_t* b);

//NAL ref idc codes
#define H264_NAL_REF_IDC_PRIORITY_HIGHEST    3
#define H264_NAL_REF_IDC_PRIORITY_HIGH       2
#define H264_NAL_REF_IDC_PRIORITY_LOW        1
#define H264_NAL_REF_IDC_PRIORITY_DISPOSABLE 0

//Table 7-1 NAL unit type codes
#define H264_NAL_UNIT_TYPE_UNSPECIFIED                    0    // Unspecified
#define H264_NAL_UNIT_TYPE_CODED_SLICE_NON_IDR            1    // Coded slice of a non-IDR picture
#define H264_NAL_UNIT_TYPE_CODED_SLICE_DATA_PARTITION_A   2    // Coded slice data partition A
#define H264_NAL_UNIT_TYPE_CODED_SLICE_DATA_PARTITION_B   3    // Coded slice data partition B
#define H264_NAL_UNIT_TYPE_CODED_SLICE_DATA_PARTITION_C   4    // Coded slice data partition C
#define H264_NAL_UNIT_TYPE_CODED_SLICE_IDR                5    // Coded slice of an IDR picture
#define H264_NAL_UNIT_TYPE_SEI                            6    // Supplemental enhancement information (SEI)
#define H264_NAL_UNIT_TYPE_SPS                            7    // Sequence parameter set
#define H264_NAL_UNIT_TYPE_PPS                            8    // Picture parameter set
#define H264_NAL_UNIT_TYPE_AUD                            9    // Access unit delimiter
#define H264_NAL_UNIT_TYPE_END_OF_SEQUENCE               10    // End of sequence
#define H264_NAL_UNIT_TYPE_END_OF_STREAM                 11    // End of stream
#define H264_NAL_UNIT_TYPE_FILLER                        12    // Filler data
#define H264_NAL_UNIT_TYPE_SPS_EXT                       13    // Sequence parameter set extension
#define H264_NAL_UNIT_TYPE_PREFIX_NAL                    14    // Prefix NAL unit
#define H264_NAL_UNIT_TYPE_SUBSET_SPS                    15    // Subset Sequence parameter set
#define H264_NAL_UNIT_TYPE_DPS                           16    // Depth Parameter Set
                                                  // 17..18    // Reserved
#define H264_NAL_UNIT_TYPE_CODED_SLICE_AUX               19    // Coded slice of an auxiliary coded picture without partitioning
#define H264_NAL_UNIT_TYPE_CODED_SLICE_SVC_EXTENSION     20    // Coded slice of SVC extension
                                             // 20..23    // Reserved
                                             // 24..31    // Unspecified
...
#define H264_SH_SLICE_TYPE_P        0        // P (P slice)
#define H264_SH_SLICE_TYPE_B        1        // B (B slice)
#define H264_SH_SLICE_TYPE_I        2        // I (I slice)
#define H264_SH_SLICE_TYPE_EP       0        // EP (EP slice)
#define H264_SH_SLICE_TYPE_EB       1        // EB (EB slice)
#define H264_SH_SLICE_TYPE_EI       2        // EI (EI slice)
#define H264_SH_SLICE_TYPE_SP       3        // SP (SP slice)
#define H264_SH_SLICE_TYPE_SI       4        // SI (SI slice)
//as per footnote to Table 7-6, the *_ONLY slice types indicate that all other slices in that picture are of the same type
#define H264_SH_SLICE_TYPE_P_ONLY    5        // P (P slice)
#define H264_SH_SLICE_TYPE_B_ONLY    6        // B (B slice)
#define H264_SH_SLICE_TYPE_I_ONLY    7        // I (I slice)
#define H264_SH_SLICE_TYPE_EP_ONLY   5        // EP (EP slice)
#define H264_SH_SLICE_TYPE_EB_ONLY   6        // EB (EB slice)
#define H264_SH_SLICE_TYPE_EI_ONLY   7        // EI (EI slice)
#define H264_SH_SLICE_TYPE_SP_ONLY   8        // SP (SP slice)
#define H264_SH_SLICE_TYPE_SI_ONLY   9        // SI (SI slice)

//Appendix E. Table E-1  Meaning of sample aspect ratio indicator
#define H264_SAR_Unspecified  0           // Unspecified
#define H264_SAR_1_1        1             //  1:1
#define H264_SAR_12_11      2             // 12:11
#define H264_SAR_10_11      3             // 10:11
#define H264_SAR_16_11      4             // 16:11
#define H264_SAR_40_33      5             // 40:33
#define H264_SAR_24_11      6             // 24:11
#define H264_SAR_20_11      7             // 20:11
#define H264_SAR_32_11      8             // 32:11
#define H264_SAR_80_33      9             // 80:33
#define H264_SAR_18_11     10             // 18:11
#define H264_SAR_15_11     11             // 15:11
#define H264_SAR_64_33     12             // 64:33
#define H264_SAR_160_99    13             // 160:99
                                     // 14..254           Reserved
#define H264_SAR_Extended      255        // Extended_SAR

//7.4.3.1 Table 7-7 reordering_of_pic_nums_idc operations for reordering of reference picture lists
#define H264_RPLR_IDC_ABS_DIFF_ADD       0
#define H264_RPLR_IDC_ABS_DIFF_SUBTRACT  1
#define H264_RPLR_IDC_LONG_TERM          2
#define H264_RPLR_IDC_END                3

//7.4.3.3 Table 7-9 Memory management control operation (memory_management_control_operation) values
#define H264_MMCO_END                     0
#define H264_MMCO_SHORT_TERM_UNUSED       1
#define H264_MMCO_LONG_TERM_UNUSED        2
#define H264_MMCO_SHORT_TERM_TO_LONG_TERM 3
#define H264_MMCO_LONG_TERM_MAX_INDEX     4
#define H264_MMCO_ALL_UNUSED              5
#define H264_MMCO_CURRENT_TO_LONG_TERM    6

//7.4.2.4 Table 7-5 Meaning of primary_pic_type
#define H264_AUD_PRIMARY_PIC_TYPE_I       0                // I
#define H264_AUD_PRIMARY_PIC_TYPE_IP      1                // I, P
#define H264_AUD_PRIMARY_PIC_TYPE_IPB     2                // I, P, B
#define H264_AUD_PRIMARY_PIC_TYPE_SI      3                // SI
#define H264_AUD_PRIMARY_PIC_TYPE_SISP    4                // SI, SP
#define H264_AUD_PRIMARY_PIC_TYPE_ISI     5                // I, SI
#define H264_AUD_PRIMARY_PIC_TYPE_ISIPSP  6                // I, SI, P, SP
#define H264_AUD_PRIMARY_PIC_TYPE_ISIPSPB 7                // I, SI, P, SP, B

#define H264_H264_PROFILE_BASELINE  66
#define H264_H264_PROFILE_MAIN      77
#define H264_H264_PROFILE_EXTENDED  88
#define H264_H264_PROFILE_HIGH     100
