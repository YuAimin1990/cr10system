...
AR_CHAR* Path_BMP = AR_NULL;

AR_S32 REGION_MST_LoadBmp(const char* filename, BITMAP_S* pstBitmap, AR_BOOL bFil, AR_U32 u16FilColor, PIXEL_FORMAT_E enPixelFmt)
{
    OSD_SURFACE_S Surface;
    OSD_BITMAPFILEHEADER bmpFileHeader;
    OSD_BITMAPINFO bmpInfo;
    AR_U32 u32BytePerPix = 0;
    ...
    CreateSurfaceByBitMap(filename, &Surface, (AR_U8*)(pstBitmap->pData));
    ...
    pu16Temp = (AR_U16*)pstBitmap->pData;
...
AR_S32 REGION_MST_UpdateCanvas(const char* filename, BITMAP_S* pstBitmap, AR_BOOL bFil,
                               AR_U32 u16FilColor, SIZE_S* pstSize, AR_U32 u32Stride, PIXEL_FORMAT_E enPixelFmt)
{
    OSD_SURFACE_S Surface;
    OSD_BITMAPFILEHEADER bmpFileHeader;
    OSD_BITMAPINFO bmpInfo;
    ...
    CreateSurfaceByCanvas(filename, &Surface, (AR_U8*)(pstBitmap->pData), pstSize->u32Width, pstSize->u32Height, u32Stride);
...
AR_S32 SAMPLE_REGION_CreateOverLay(AR_S32 HandleNum)
{
    AR_S32 s32Ret;
    AR_S32 i;
    RGN_ATTR_S stRegion;
    ...
    {
        s32Ret = AR_MPI_RGN_Create(i, &stRegion);
        if(AR_SUCCESS != s32Ret)
        {
            SAMPLE_PRT("AR_MPI_RGN_Create failed with %#x!\n", s32Ret);
            return AR_FAILURE;
        }
    }
...
AR_S32 SAMPLE_REGION_CreateOverLayEx(AR_S32 HandleNum)
{
    AR_S32 s32Ret;
    AR_S32 i;
    RGN_ATTR_S stRegion;
...
AR_S32 SAMPLE_REGION_CreateCover(AR_S32 HandleNum)
{
    AR_S32 s32Ret;
    AR_S32 i;
    RGN_ATTR_S stRegion;
...
AR_S32 SAMPLE_REGION_CreateCoverEx(AR_S32 HandleNum)
{
    AR_S32 s32Ret;
    AR_S32 i;
    RGN_ATTR_S stRegion;
...
AR_S32 SAMPLE_REGION_CreateMosaic(AR_S32 HandleNum)
{
    AR_S32 s32Ret;
    AR_S32 i;
    RGN_ATTR_S stRegion;
...
AR_S32 SAMPLE_REGION_Destroy(RGN_HANDLE Handle)
{
    AR_S32 s32Ret;
    s32Ret = AR_MPI_RGN_Destroy(Handle);
    if(AR_SUCCESS != s32Ret)
    {
        SAMPLE_PRT("AR_MPI_RGN_Destroy failed with %#x!\n", s32Ret);
        return AR_FAILURE;
    }
    return s32Ret;
}

AR_S32 SAMPLE_REGION_SetAttr(RGN_HANDLE Handle,RGN_ATTR_S *pstRegion)
{
    AR_S32 s32Ret;
    s32Ret = AR_MPI_RGN_SetAttr(Handle,pstRegion);
    if(AR_SUCCESS != s32Ret)
    {
        SAMPLE_PRT("AR_MPI_RGN_SetAttr failed with %#x!\n", s32Ret);
        return AR_FAILURE;
    }
    return s32Ret;
}

AR_S32 SAMPLE_REGION_GetAttr(RGN_HANDLE Handle,RGN_ATTR_S *pstRegion)
{
    AR_S32 s32Ret;
    s32Ret = AR_MPI_RGN_Create(Handle,pstRegion);
    if(AR_SUCCESS != s32Ret)
    {
        SAMPLE_PRT("AR_MPI_RGN_Create failed with %#x!\n", s32Ret);
        return AR_FAILURE;
...
AR_S32 SAMPLE_REGION_AttachToChn(RGN_HANDLE Handle,MPP_CHN_S *pstChn, RGN_CHN_ATTR_S *pstChnAttr)
{
    AR_S32 s32Ret;
    s32Ret = AR_MPI_RGN_AttachToChn(Handle, pstChn,pstChnAttr);
    if(AR_SUCCESS != s32Ret)
    {
        SAMPLE_PRT("AR_MPI_RGN_AttachToChn failed with %#x!\n", s32Ret);
        return AR_FAILURE;
    }
    return s32Ret;
}

AR_S32 SAMPLE_REGION_DetachFromChn(RGN_HANDLE Handle,MPP_CHN_S *pstChn)
{
    AR_S32 s32Ret;
    s32Ret = AR_MPI_RGN_DetachFromChn(Handle, pstChn);
    if(AR_SUCCESS != s32Ret)
    {
        SAMPLE_PRT("AR_MPI_RGN_DetachFromChn failed with %#x!\n", s32Ret);
        return AR_FAILURE;
    }
    return s32Ret;
}

AR_S32 SAMPLE_REGION_SetDisplayAttr(RGN_HANDLE Handle,MPP_CHN_S *pstChn, RGN_CHN_ATTR_S *pstChnAttr)
{
    AR_S32 s32Ret;
    s32Ret = AR_MPI_RGN_SetDisplayAttr(Handle,pstChn, pstChnAttr);
    if(AR_SUCCESS != s32Ret)
    {
        SAMPLE_PRT("AR_MPI_RGN_SetDisplayAttr failed with %#x!\n", s32Ret);
        return AR_FAILURE;
    }
    return s32Ret;
}

AR_S32 SAMPLE_REGION_GetDisplayAttr(RGN_HANDLE Handle,MPP_CHN_S *pstChn, RGN_CHN_ATTR_S *pstChnAttr)
{
    AR_S32 s32Ret;
    s32Ret = AR_MPI_RGN_GetDisplayAttr(Handle,pstChn,pstChnAttr);
    if(AR_SUCCESS != s32Ret)
    {
        SAMPLE_PRT("AR_MPI_RGN_GetDisplayAttr failed with %#x!\n", s32Ret);
        return AR_FAILURE;
    }
    return s32Ret;
}

AR_S32 SAMPLE_REGION_SetBitMap(RGN_HANDLE Handle, BITMAP_S *pstBitmap)
{
    AR_S32 s32Ret;
    s32Ret = AR_MPI_RGN_SetBitMap(Handle,pstBitmap);
    if(AR_SUCCESS != s32Ret)
    {
        SAMPLE_PRT("AR_MPI_RGN_SetBitMap failed with %#x!\n", s32Ret);
        return AR_FAILURE;
    }
    return s32Ret;
}

AR_S32 SAMPLE_REGION_GetUpCanvasInfo(RGN_HANDLE Handle, RGN_CANVAS_INFO_S *pstCanvasInfo)
{
    AR_S32 s32Ret;
    s32Ret = AR_MPI_RGN_GetCanvasInfo(Handle,pstCanvasInfo);
    if(AR_SUCCESS != s32Ret)
    {
        SAMPLE_PRT("AR_MPI_RGN_GetCanvasInfo failed with %#x!\n", s32Ret);
        return AR_FAILURE;
    }
    ...
    if(AR_SUCCESS != s32Ret)
    {
        SAMPLE_PRT("AR_MPI_RGN_UpdateCanvas failed with %#x!\n", s32Ret);
        return AR_FAILURE;
    }
    return s32Ret;
}
...
AR_S32 SAMPLE_COMM_REGION_AttachToChn(AR_S32 HandleNum,RGN_TYPE_E enType, MPP_CHN_S *pstMppChn)
{
    ...
    switch(enType)
        ...
        case OVERLAY_RGN:
            ...
            stChnAttr.unChnAttr.stOverlayChn.stQpInfo.bAbsQp = AR_TRUE;
            ...
            stChnAttr.unChnAttr.stOverlayChn.stInvertColor.bInvColEn = AR_FALSE;
        ...
        case COVER_RGN:
            ...
            stChnAttr.unChnAttr.stCoverChn.u32Color      = 0xffffffff;
        ...
        case COVEREX_RGN:
            ...
            stChnAttr.unChnAttr.stCoverExChn.u32Color      = 0xff0000ff;
            break;
        case MOSAIC_RGN:
            MinHadle = MosaicMinHandle;
    ...
    for(i =MinHadle; i <MinHadle+HandleNum;i++)
    {
        ...
        if(COVER_RGN == enType)
        {
            stChnAttr.unChnAttr.stCoverChn.stRect.s32X = 50 + 200*(i - CoverMinHandle) ;
            stChnAttr.unChnAttr.stCoverChn.stRect.s32Y = 50 + 200*(i - CoverMinHandle);
            stChnAttr.unChnAttr.stCoverChn.u32Layer = i - CoverMinHandle;
        }
        if(COVEREX_RGN == enType)
        {
            stChnAttr.unChnAttr.stCoverExChn.stRect.s32X = 50 + 200*(i - CoverExMinHandle);
            stChnAttr.unChnAttr.stCoverExChn.stRect.s32Y = 50 + 200*(i - CoverExMinHandle);
            stChnAttr.unChnAttr.stCoverExChn.u32Layer = i - CoverExMinHandle;
        }
        if(MOSAIC_RGN == enType)
        {
            stChnAttr.unChnAttr.stMosaicChn.stRect.s32X = 80 + 200*(i-MosaicMinHandle);
            stChnAttr.unChnAttr.stMosaicChn.stRect.s32Y = 80 + 200*(i-MosaicMinHandle);
...
AR_S32 SAMPLE_COMM_REGION_SetBitMap(RGN_HANDLE Handle)
{
   ...
   REGION_MST_LoadBmp(Path_BMP, &stBitmap, AR_FALSE, 0,PIXEL_FORMAT_ARGB_1555);
...
AR_S32 SAMPLE_COMM_REGION_GetUpCanvas(RGN_HANDLE Handle)
{
    ...
    stBitmap.pData   = (AR_VOID*)(AR_U64)stCanvasInfo.u64VirtAddr;
    stSize.u32Width  = stCanvasInfo.stSize.u32Width;
    stSize.u32Height = stCanvasInfo.stSize.u32Height;
    REGION_MST_UpdateCanvas(Path_BMP, &stBitmap, AR_FALSE, 0, &stSize, stCanvasInfo.u32Stride, PIXEL_FORMAT_ARGB_1555);
