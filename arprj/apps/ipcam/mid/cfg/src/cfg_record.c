...
CFG_MAP recordMap[IPC_MAX_PIPELINE_NUM][IPC_MAX_VENC_STREAM_PER_CHN][12] =
{
    //channel 0:
    {
        //stream 0
        {
            {"enable",           &g_stRunRecordCfg.stRecord[0][0].enable,                CFG_DATA_TYPE_S32,   "1",   "rw", 0, 1,   NULL},
            ...
            {"audioRecEnable", &g_stRunRecordCfg.stRecord[0][0].audioRecEnable,       CFG_DATA_TYPE_S32,   "1",   "rw", 0, 1,   NULL},
        ...
        //stream 1
        {
            {"enable",           &g_stRunRecordCfg.stRecord[0][1].enable,                CFG_DATA_TYPE_S32,   "1",   "rw", 0, 1,   NULL},
            ...
            {"audioRecEnable", &g_stRunRecordCfg.stRecord[0][1].audioRecEnable,       CFG_DATA_TYPE_S32,   "1",   "rw", 0, 1,   NULL},
        ...
        //stream 2
        {
            ...
            {"audioRecEnable", &g_stRunRecordCfg.stRecord[0][2].audioRecEnable,       CFG_DATA_TYPE_S32,   "1",   "rw", 0, 1,   NULL},
