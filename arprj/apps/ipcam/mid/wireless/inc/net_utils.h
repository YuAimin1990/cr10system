 ...
 */
extern void net_ipstr2byte(unsigned char * const bytes,const char *ip);
/*
...
extern int net_get_if_addr(char *eth, char * const ip, char * const mac);
//extern int net_getipbyname(const char *hostname, struct in_addr* in_addr);
