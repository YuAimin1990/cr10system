...
void IPC_MID_UTIL_TIMER_Suspend()
{
	timerSuspend = 1;
	printf("IPC_MID_UTIL_TIMER_Suspend \n");
}

void IPC_MID_UTIL_TIMER_Resume()
{
	timerSuspend = 0;
	printf("IPC_MID_UTIL_TIMER_Resume \n");
}
