...
static int IRAW_W = 512;
static int IRAW_H = 200;
...
static void *temperature_measure_thread(void* arg)
{
    ...
    while(1)
    {
        ...
        iPosY16 = g_stTempMeasureParam.y16data[256*iPosY + iPosX];
...
AR_S32 SAMPLE_timo256af_test(AR_S32 outMode)
{
    AR_S32             s32Ret;
    ...
    
    {
        ...
        g_enSnsType[s32WorkSnsId] = TIMO256AF_DVP_256_IR;
    	...
    	stViConfig.astViInfo[s32WorkSnsId].stSnsInfo.enSnsType = TIMO256AF_DVP_256_IR;
    ...
    while(1)
	{
        ...
        enItaResult = guide_push_raw_data((unsigned char *)(tmp_buf.pViraddr+512*4), IRAW_W*192, &stITAISPResult);
