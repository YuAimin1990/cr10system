...
extern "C"
{
    ...
    typedef enum {
        ALG_IMG_CTL_BRIGHT, //亮度
        ALG_IMG_CTL_CONTRAST, //对比度
    }ENUM_ALG_IMAGE_CTL_TYPE;
    ...
    struct arINF_ALGO_OBJECT_S
    {
        ...
        //alg
        int (* gtm_process)(INF_ALGO_OBJECT_S* pObj,void *input,void *output, int stride);
        int (* lms_process)(INF_ALGO_OBJECT_S* pObj,void *input,void *output, int stride);
        ...
        //image control
        int (* image_control_get)(INF_ALGO_OBJECT_S* pObj, ENUM_ALG_IMAGE_CTL_TYPE ctl_type, int *p_percent); //0-100
        int (* image_control_set)(INF_ALGO_OBJECT_S* pObj, ENUM_ALG_IMAGE_CTL_TYPE ctl_type, int percent); //0-100
        //other
        void *pri;
        void *usr;
    };
