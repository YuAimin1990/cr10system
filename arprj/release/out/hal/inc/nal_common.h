...
//			/* The number of bits in this syntax structure is not affected by this condition */	
	...
	uint8 general_max_14bit_constraint_flag;
	uint64 general_reserved_zero_33bits;

	uint8 general_reserved_zero_7bits;
	uint64 general_reserved_zero_35bits;
...
void read_profile_tier_level(nal_buffer_t * pnal_buffer, int maxNumSubLayersMinus1, profile_tier_level_data_t *profile_tier_level_data);
...
void print_profile_tier_level(profile_tier_level_data_t *ptl, uint8 maxNumSubLayersMinus1);
