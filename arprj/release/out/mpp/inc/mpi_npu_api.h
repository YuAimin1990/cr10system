...
/**
* @brief  npu后处理接口.
* @param  handle  加载npu分配的句柄；pstStatus  npu状态信息； pu32OutputAddr 数据输出地址
* @retval 0 成功 , 其它 失败.
* @note
*/
AR_S32 AR_MPI_NPU_PostProcess(void * handle, AR_U32 * pu32OutputAddr);
/**
...
* @note
*/
AR_U32 AR_MPI_NPU_GetFrameNum(void * handle);
...
* @note
*/
AR_S32 AR_MPI_NPU_DumpcBuffer(AR_CHAR * pchFile);
/**
...
* @note
*/
AR_S32 AR_MPI_NPU_ClearcBuffer();
...
/**
* @brief 设置打印等级
* @param u32LogLevel打印等级
* @retval < 0 失败,其他 成功
* @note ERR:0 WARNING:1  DEBUG:2 INFO:3
**/
AR_S32 AR_MPI_NPU_SetLogLevel(AR_U32 u32LogLevel);
...
*/
AR_S32 AR_MPI_NPU_Forward_WithMultiBuff(void * handle, AR_IMG_SET_S * pstImg, AR_MEM_S * pIns, AR_MEM_S * pOut, AR_U32 u32BuffNum, AR_BOOL bInstant, AR_BOOL bDebug);
