...
#ifndef __MPI_UNF_CIPHER_H__
#define __MPI_UNF_CIPHER_H__
...
/** Cipher work mode */
typedef enum arUNF_CIPHER_WORK_MODE_E
{
    UNF_CIPHER_WORK_MODE_ECB,        /**<Electronic codebook (ECB) mode*/
    UNF_CIPHER_WORK_MODE_CBC,        /**<Cipher block chaining (CBC) mode*/
    UNF_CIPHER_WORK_MODE_CFB,        /**<Cipher feedback (CFB) mode*/
    UNF_CIPHER_WORK_MODE_OFB,        /**<Output feedback (OFB) mode*/
    UNF_CIPHER_WORK_MODE_CTR,        /**<Counter (CTR) mode*/
    UNF_CIPHER_WORK_MODE_CCM,        /**<Counter (CCM) mode*/
    UNF_CIPHER_WORK_MODE_GCM,        /**<Counter (GCM) mode*/
    UNF_CIPHER_WORK_MODE_CBC_CTS,    /**<Cipher block chaining CipherStealing mode*/
    UNF_CIPHER_WORK_MODE_BUTT,
    UNF_CIPHER_WORK_MODE_INVALID  = 0xffffffff,
}UNF_CIPHER_WORK_MODE_E;

/** Cipher algorithm */
typedef enum arUNF_CIPHER_ALG_E
{
    UNF_CIPHER_ALG_DES           = 0x0,  /**< Data encryption standard (DES) algorithm */
    UNF_CIPHER_ALG_3DES          = 0x1,  /**< 3DES algorithm */
    UNF_CIPHER_ALG_AES           = 0x2,  /**< Advanced encryption standard (AES) algorithm */
    UNF_CIPHER_ALG_SM1           = 0x3,  /**<SM1 algorithm*/
    UNF_CIPHER_ALG_SM4           = 0x4,  /**<SM4 algorithm*/
    UNF_CIPHER_ALG_DMA           = 0x5,  /**<DMA copy*/
    UNF_CIPHER_ALG_BUTT          = 0x6,
    UNF_CIPHER_ALG_INVALID       = 0xffffffff,
}UNF_CIPHER_ALG_E;

/** Key length */
typedef enum arUNF_CIPHER_KEY_LENGTH_E
{
    UNF_CIPHER_KEY_AES_128BIT    = 0x0,  /**< 128-bit key for the AES algorithm */
    UNF_CIPHER_KEY_AES_192BIT    = 0x1,  /**< 192-bit key for the AES algorithm */
    UNF_CIPHER_KEY_AES_256BIT    = 0x2,  /**< 256-bit key for the AES algorithm */
    UNF_CIPHER_KEY_DES_3KEY      = 0x2,  /**< Three keys for the DES algorithm */
    UNF_CIPHER_KEY_DES_2KEY      = 0x3,  /**< Two keys for the DES algorithm */
    UNF_CIPHER_KEY_DEFAULT       = 0x0,  /**< default key length, DES-8, SM1-48, SM4-16 */
    UNF_CIPHER_KEY_INVALID       = 0xffffffff,
}UNF_CIPHER_KEY_LENGTH_E;

/** Cipher bit width */
typedef enum arUNF_CIPHER_BIT_WIDTH_E
{
    UNF_CIPHER_BIT_WIDTH_64BIT   = 0x0,  /**< 64-bit width */
    UNF_CIPHER_BIT_WIDTH_8BIT    = 0x1,  /**< 8-bit width */
    UNF_CIPHER_BIT_WIDTH_1BIT    = 0x2,  /**< 1-bit width */
    UNF_CIPHER_BIT_WIDTH_128BIT  = 0x3,  /**< 128-bit width */
    UNF_CIPHER_BIT_WIDTH_INVALID = 0xffffffff,
}UNF_CIPHER_BIT_WIDTH_E;

/** Cipher control parameters */
typedef struct arTEE_CIPHER_CTRL_CHANGE_FLAG_S
{
...
typedef enum arTEE_CIPHER_CA_TYPE_E
{
    UNF_CIPHER_KEY_SRC_USER       = 0x0,  /**< User Key*/
    UNF_CIPHER_KEY_SRC_KLAD_1,           /**< KLAD Key 1*/
    UNF_CIPHER_KEY_SRC_KLAD_2,           /**< KLAD Key 2*/
    UNF_CIPHER_KEY_SRC_KLAD_3,           /**< KLAD Key 3*/
...
typedef enum
{
    UNF_CIPHER_KLAD_TARGET_AES       = 0x0,  /**< Klad for AES*/
    UNF_CIPHER_KLAD_TARGET_RSA,              /**< Klad for RSA*/
...
/** sm1 round config */
typedef enum arUNF_CIPHER_SM1_ROUND_E
{
    UNF_CIPHER_SM1_ROUND_08 = 0x00,            /**< sm1 round 08 */
    UNF_CIPHER_SM1_ROUND_10 = 0x01,            /**< sm1 round 10 */
    UNF_CIPHER_SM1_ROUND_12 = 0x02,            /**< sm1 round 12 */
    UNF_CIPHER_SM1_ROUND_14 = 0x03,            /**< sm1 round 14 */
...
typedef struct arUNF_CIPHER_CTRL_S
{
    ...
    UNF_CIPHER_CA_TYPE_E enCaType;               /**< Select keyladder type when using advanced CA */
    UNF_CIPHER_ALG_E enAlg;                      /**< Cipher algorithm */
    UNF_CIPHER_BIT_WIDTH_E enBitWidth;           /**< Bit width for encryption or decryption */
    UNF_CIPHER_WORK_MODE_E enWorkMode;           /**< Operating mode */
    UNF_CIPHER_KEY_LENGTH_E enKeyLen;            /**< Key length */
    UNF_CIPHER_CTRL_CHANGE_FLAG_S stChangeFlags; /**< control information exchange choices, we default all would be change except they have been in the choices */
} UNF_CIPHER_CTRL_S;

/** Structure of the cipher AES control information */
typedef struct arUNF_CIPHER_CTRL_AES_S
{
    ...
    UNF_CIPHER_BIT_WIDTH_E enBitWidth;           /**< Bit width for encryption or decryption */
    UNF_CIPHER_KEY_LENGTH_E enKeyLen;            /**< Key length */
    UNF_CIPHER_CTRL_CHANGE_FLAG_S stChangeFlags; /**< control information exchange choices, we default all woulde be change except they have been in the choices */
} UNF_CIPHER_CTRL_AES_S;

/** Structure of the cipher AES CCM/GCM control information */
typedef struct arUNF_CIPHER_CTRL_AES_CCM_GCM_S
{
    AR_U32 u32Key[8];                               /**< Key input */
    AR_U32 u32IV[4];                                /**< Initialization vector (IV) */
    UNF_CIPHER_KEY_LENGTH_E enKeyLen;            /**< Key length */
...
typedef struct arUNF_CIPHER_CTRL_DES_S
{
...
typedef struct arUNF_CIPHER_CTRL_3DES_S
{
...
typedef struct arUNF_CIPHER_CTRL_SM1_S
{
    ...
    AR_U32 u32IV[4];                                /**< Initialization vector (IV) */
    UNF_CIPHER_BIT_WIDTH_E enBitWidth;           /**< Bit width for encryption or decryption */
    UNF_CIPHER_SM1_ROUND_E enSm1Round;           /**< SM1 round number, should be 8, 10, 12 or 14*/
    UNF_CIPHER_CTRL_CHANGE_FLAG_S stChangeFlags; /**< control information exchange choices, we default all woulde be change except they have been in the choices */
} UNF_CIPHER_CTRL_SM1_S;

/** Structure of the cipher SM4 control information */
typedef struct arUNF_CIPHER_CTRL_SM4_S
{
...
typedef struct arUNF_CIPHER_CTRL_EX_S
{
    UNF_CIPHER_ALG_E enAlg;                      /**< Cipher algorithm */
    UNF_CIPHER_WORK_MODE_E enWorkMode;           /**< Operating mode */
    AR_BOOL bKeyByCA;                               /**< Encryption using advanced conditional access (CA) or decryption using keys */
    /**< Parameter for special algorithm
        for AES, the pointer should point to UNF_CIPHER_CTRL_AES_S;
        for AES_CCM or AES_GCM, the pointer should point to UNF_CIPHER_CTRL_AES_CCM_GCM_S;
        for DES, the pointer should point to UNF_CIPHER_CTRL_DES_S;
        for 3DES, the pointer should point to UNF_CIPHER_CTRL_3DES_S;
        for SM1, the pointer should point to UNF_CIPHER_CTRL_SM1_S;
        for SM4, the pointer should point to UNF_CIPHER_CTRL_SM4_S;
    */
    AR_VOID *pParam;
} UNF_CIPHER_CTRL_EX_S;

/** Cipher data */
typedef struct arUNF_CIPHER_DATA_S
{
...
/** Hash algrithm type */
typedef enum arUNF_CIPHER_HASH_TYPE_E
{
...
typedef enum arUNF_CIPHER_RSA_ENC_SCHEME_E
{
    UNF_CIPHER_RSA_ENC_SCHEME_NO_PADDING,            /**< without padding */
    UNF_CIPHER_RSA_ENC_SCHEME_BLOCK_TYPE_0,          /**< PKCS#1 block type 0 padding*/
    UNF_CIPHER_RSA_ENC_SCHEME_BLOCK_TYPE_1,          /**< PKCS#1 block type 1 padding*/
    UNF_CIPHER_RSA_ENC_SCHEME_BLOCK_TYPE_2,          /**< PKCS#1 block type 2 padding*/
    UNF_CIPHER_RSA_ENC_SCHEME_RSAES_OAEP_SHA1,       /**< PKCS#1 RSAES-OAEP-SHA1 padding*/
    UNF_CIPHER_RSA_ENC_SCHEME_RSAES_OAEP_SHA224,     /**< PKCS#1 RSAES-OAEP-SHA224 padding*/
    UNF_CIPHER_RSA_ENC_SCHEME_RSAES_OAEP_SHA256,     /**< PKCS#1 RSAES-OAEP-SHA256 padding*/
    UNF_CIPHER_RSA_ENC_SCHEME_RSAES_OAEP_SHA384,     /**< PKCS#1 RSAES-OAEP-SHA384 padding*/
    UNF_CIPHER_RSA_ENC_SCHEME_RSAES_OAEP_SHA512,     /**< PKCS#1 RSAES-OAEP-SHA512 padding*/
    UNF_CIPHER_RSA_ENC_SCHEME_RSAES_PKCS1_V1_5,      /**< PKCS#1 RSAES-PKCS1_V1_5 padding*/
    UNF_CIPHER_RSA_ENC_SCHEME_BUTT,
    UNF_CIPHER_RSA_ENC_SCHEME_INVALID  = 0xffffffff,
}UNF_CIPHER_RSA_ENC_SCHEME_E;

typedef enum arUNF_CIPHER_RSA_SIGN_SCHEME_E
{
    UNF_CIPHER_RSA_SIGN_SCHEME_RSASSA_PKCS1_V15_SHA1 = 0x100, /**< PKCS#1 RSASSA_PKCS1_V15_SHA1 signature*/
    UNF_CIPHER_RSA_SIGN_SCHEME_RSASSA_PKCS1_V15_SHA224,       /**< PKCS#1 RSASSA_PKCS1_V15_SHA224 signature*/
    UNF_CIPHER_RSA_SIGN_SCHEME_RSASSA_PKCS1_V15_SHA256,       /**< PKCS#1 RSASSA_PKCS1_V15_SHA256 signature*/
    UNF_CIPHER_RSA_SIGN_SCHEME_RSASSA_PKCS1_V15_SHA384,       /**< PKCS#1 RSASSA_PKCS1_V15_SHA384 signature*/
    UNF_CIPHER_RSA_SIGN_SCHEME_RSASSA_PKCS1_V15_SHA512,       /**< PKCS#1 RSASSA_PKCS1_V15_SHA512 signature*/
    UNF_CIPHER_RSA_SIGN_SCHEME_RSASSA_PKCS1_PSS_SHA1,         /**< PKCS#1 RSASSA_PKCS1_PSS_SHA1 signature*/
    UNF_CIPHER_RSA_SIGN_SCHEME_RSASSA_PKCS1_PSS_SHA224,       /**< PKCS#1 RSASSA_PKCS1_PSS_SHA224 signature*/
    UNF_CIPHER_RSA_SIGN_SCHEME_RSASSA_PKCS1_PSS_SHA256,       /**< PKCS#1 RSASSA_PKCS1_PSS_SHA256 signature*/
    UNF_CIPHER_RSA_SIGN_SCHEME_RSASSA_PKCS1_PSS_SHA384,       /**< PKCS#1 RSASSA_PKCS1_PSS_SHA1 signature*/
    UNF_CIPHER_RSA_SIGN_SCHEME_RSASSA_PKCS1_PSS_SHA512,       /**< PKCS#1 RSASSA_PKCS1_PSS_SHA256 signature*/
...
typedef struct
{
    UNF_CIPHER_RSA_ENC_SCHEME_E enScheme;   /** RSA encryption scheme*/
    UNF_CIPHER_RSA_PUB_KEY_S stPubKey;      /** RSA private key struct */
...
{
    UNF_CIPHER_RSA_ENC_SCHEME_E enScheme; /** RSA encryption scheme */
    UNF_CIPHER_RSA_PRI_KEY_S stPriKey;    /** RSA public key struct */
    UNF_CIPHER_CA_TYPE_E enCaType;
...
typedef struct
{
    UNF_CIPHER_RSA_SIGN_SCHEME_E enScheme;  /** RSA signature scheme*/
    UNF_CIPHER_RSA_PRI_KEY_S stPriKey;      /** RSA private key struct */
    UNF_CIPHER_CA_TYPE_E enCaType;
...
{
    UNF_CIPHER_RSA_SIGN_SCHEME_E enScheme; /** RSA signature scheme*/
    UNF_CIPHER_RSA_PUB_KEY_S stPubKey;     /** RSA public key struct */
 }UNF_CIPHER_RSA_VERIFY_S;

/** @} */  /** <!-- ==== Structure Definition End ==== */


#define UNF_CIPHER_Open(AR_VOID) UNF_CIPHER_Init(AR_VOID);
#define UNF_CIPHER_Close(AR_VOID) UNF_CIPHER_DeInit(AR_VOID);
...
N/A
*/
AR_S32 AR_MPI_UNF_CIPHER_Init(AR_VOID);
...
N/A
*/
AR_S32 AR_MPI_UNF_CIPHER_DeInit(AR_VOID);
...
N/A
*/
AR_S32 AR_MPI_UNF_CIPHER_CreateHandle(AR_HANDLE* phCipher, const UNF_CIPHER_ATTS_S *pstCipherAttr);
...
N/A
*/
AR_S32 AR_MPI_UNF_CIPHER_DestroyHandle(AR_HANDLE hCipher);
...
N/A
*/
AR_S32 AR_MPI_UNF_CIPHER_ConfigHandle(AR_HANDLE hCipher, const UNF_CIPHER_CTRL_S* pstCtrl);
...
N/A
*/
AR_S32 AR_MPI_UNF_CIPHER_ConfigHandleEx(AR_HANDLE hCipher, const UNF_CIPHER_CTRL_EX_S* pstExCtrl);
...
N/A
*/
AR_S32 AR_MPI_UNF_CIPHER_Encrypt(AR_HANDLE hCipher, AR_UINTPTR szSrcPhyAddr, AR_UINTPTR szDestPhyAddr, AR_U32 u32ByteLength);
...
N/A
*/
AR_S32 AR_MPI_UNF_CIPHER_Decrypt(AR_HANDLE hCipher, AR_UINTPTR szSrcPhyAddr, AR_UINTPTR szDestPhyAddr, AR_U32 u32ByteLength);
...
N/A
*/
AR_S32 AR_MPI_UNF_CIPHER_EncryptVir(AR_HANDLE hCipher, const AR_U8 *pu8SrcData, AR_U8 *pu8DestData, AR_U32 u32ByteLength);
...
N/A
*/
AR_S32 AR_MPI_UNF_CIPHER_DecryptVir(AR_HANDLE hCipher, const AR_U8 *pu8SrcData, AR_U8 *pu8DestData, AR_U32 u32ByteLength);
...
N/A
*/
AR_S32 AR_MPI_UNF_CIPHER_EncryptMulti(AR_HANDLE hCipher, const UNF_CIPHER_DATA_S *pstDataPkg, AR_U32 u32DataPkgNum);
...
N/A
*/
AR_S32 AR_MPI_UNF_CIPHER_GetHandleConfig(AR_HANDLE hCipher, UNF_CIPHER_CTRL_S* pstCtrl);
...
N/A
*/
AR_S32 AR_MPI_UNF_CIPHER_DecryptMulti(AR_HANDLE hCipher, const UNF_CIPHER_DATA_S *pstDataPkg, AR_U32 u32DataPkgNum);
...
N/A
*/
AR_S32 AR_MPI_UNF_CIPHER_GetTag(AR_HANDLE hCipher, AR_U8 *pu8Tag, AR_U32 *pu32TagLen);
...
N/A
*/
AR_S32 AR_MPI_UNF_CIPHER_KladEncryptKey(UNF_CIPHER_CA_TYPE_E enRootKey,
...
N/A
*/
AR_S32 AR_MPI_UNF_CIPHER_GetRandomNumber(AR_U32 *pu32RandomNumber);
...
N/A
*/
AR_S32 AR_MPI_UNF_CIPHER_HashInit(const UNF_CIPHER_HASH_ATTS_S *pstHashAttr, AR_HANDLE *pHashHandle);
...
N/A
*/
AR_S32 AR_MPI_UNF_CIPHER_HashUpdate(AR_HANDLE hHashHandle, const AR_U8 *pu8InputData, AR_U32 u32InputDataLen);
...
N/A
*/
AR_S32 AR_MPI_UNF_CIPHER_HashFinal(AR_HANDLE hHashHandle, AR_U8 *pu8OutputHash);
...
N/A
*/
AR_S32 AR_MPI_UNF_CIPHER_RsaPublicEncrypt(const UNF_CIPHER_RSA_PUB_ENC_S *pstRsaEnc,
...
N/A
*/
AR_S32 AR_MPI_UNF_CIPHER_RsaPrivateDecrypt(const UNF_CIPHER_RSA_PRI_ENC_S *pstRsaDec,
                                    const AR_U8 *pu8Input, AR_U32 u32InLen,
                                    AR_U8 *pu8Output, AR_U32 *pu32OutLen);
...
N/A
*/
AR_S32 AR_MPI_UNF_CIPHER_RsaPrivateEncrypt(const UNF_CIPHER_RSA_PRI_ENC_S *pstRsaEnc,
                                    const AR_U8 *pu8Input, AR_U32 u32InLen,
                                    AR_U8 *pu8Output, AR_U32 *pu32OutLen);
...
N/A
*/
AR_S32 AR_MPI_UNF_CIPHER_RsaPublicDecrypt(const UNF_CIPHER_RSA_PUB_ENC_S *pstRsaDec,
                               const AR_U8 *pu8Input, AR_U32 u32InLen,
                               AR_U8 *pu8Output, AR_U32 *pu32OutLen);
...
N/A
*/
AR_S32 AR_MPI_UNF_CIPHER_RsaSign(const UNF_CIPHER_RSA_SIGN_S *pstRsaSign,
...
N/A
*/
AR_S32 AR_MPI_UNF_CIPHER_RsaVerify(const UNF_CIPHER_RSA_VERIFY_S *pstRsaVerify,
                               const AR_U8 *pu8InData, AR_U32 u32InDataLen,
                               const AR_U8 *pu8HashData,
