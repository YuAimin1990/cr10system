...
typedef struct {
	...
	unsigned int start_address;                                 /**< The memory region start address. Must be aligned to 4096 bytes. The end address is defined by next memory region start address */
...
typedef struct {
	...
	unsigned int start_address;              	                /**< The memory region start address. Must be aligned to 4096 bytes. The end address is defined by the next memory region start address.*/
...
* @param[in]     start_address   - Start address for the operation (ignored if operation_size == #MSS_PROGRAM_CACHE_OPERATION_SIZE_FULL), must be aligned to 64 bytes.
...
/**
* @brief Get a program memory region
* @param[in/out] region_settings - Pointer to the program memory region settings structure
* @return void
*/
...
/**
* @brief Get a data memory region
* @param[in/out] region_settings - Pointer to the data memory region settings structure
* @return void
*/
