...
FreeRTOS_10.3.1/Source/portable/CEVA-DSP/cevaxm6/%.o: ../FreeRTOS_10.3.1/Source/portable/CEVA-DSP/cevaxm6/%.asm
	...
	C:\CEVA-ToolBox\V18\XM6\toolbox\../cevatools/bin/clang -c -x assembler-with-cpp -Wa,-g -Wa,-rstr-check-args="-quick -verbose" -MMD -MP -MF"$(@:%.o=%.d)" --target=cevaxm6-elf -mcpu=cevaxm6v1.3.0 -mnonlinear=2 -mfp=4 -mvfp=2 -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
