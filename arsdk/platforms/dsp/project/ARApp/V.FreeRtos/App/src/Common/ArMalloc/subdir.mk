...
C_SRCS += \
../App/src/Common/ArMalloc/ArMalloc.c 

OBJS += \
./App/src/Common/ArMalloc/ArMalloc.o 

C_DEPS += \
./App/src/Common/ArMalloc/ArMalloc.d 


# Each subdirectory must supply rules for building sources it contributes
App/src/Common/ArMalloc/%.o: ../App/src/Common/ArMalloc/%.c
	@echo 'Building file: $<'
