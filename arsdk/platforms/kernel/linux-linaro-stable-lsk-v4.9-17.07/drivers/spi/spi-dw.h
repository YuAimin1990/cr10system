...
struct dw_spi {
	...
	struct spi_master_mem_ops mem_ops;
...
/*static inline u32 dw_readl_hs(struct dw_spi *dws, u32 offset)
{
	return __raw_readl(dws->hs_regs + offset);
}

#ifdef AR9301

static inline void dw_writew_hs(struct dw_spi *dws, u32 offset, u32 val)
{
	__raw_writew(val, dws->hs_regs + offset);
}

#endif

static inline void dw_writel_hs(struct dw_spi *dws, u32 offset, u32 val)
{
	__raw_writel(val, dws->hs_regs + offset);
}*/
