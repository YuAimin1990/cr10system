...
typedef int (*sirius_tcpc_notifier_call)
    (struct sirius_tcpc * tcpc, struct sirius_tcpc_notify new, int data);
...
struct sirius_tcpc {
    ...
    struct sirius_tcpc_notify   notify;
