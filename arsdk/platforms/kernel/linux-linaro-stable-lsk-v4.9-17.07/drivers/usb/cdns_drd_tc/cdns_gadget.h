/**
 * cdns_gadget.h - Cadence USB3 device Controller Core file
 *
...
#define USB_SS_ENDPOINTS_MAX_COUNT	4//30
...
#define LTSSM_LINK_STATE_U3		3
#define LPM_STATE_L2			2

#define ENABLE_ALL_INTERRUPTS_MASK	0xFFFFFFFF

#define ACTUAL_TRANSFERRED_BYTES_MASK	0x1FFFF

#define ENDPOINT_DIR_MASK		0x80

#define ENDPOINT_CPU_ADDR_ALLOC_SIZE	4096

#define ENDPOINT0_TRB_ALLOC_SIZE	20

#define SETUP_BUFFER_ALLOC_SIZE		8

#define SET_SEL_REQ_SIZE		6
