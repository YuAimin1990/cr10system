...
#ifndef __REG_USBSS_DRD_ADDR_MAP_MACRO_H__
#define __REG_USBSS_DRD_ADDR_MAP_MACRO_H__
...
#define OTGCMD_TYPE__SS_HOST_DISABLED_CLR__MASK                     0x00100000U
#define OTGCMD_TYPE__SS_PERIPH_DISABLED_SET__MASK                   0x00200000U
#define OTGCMD_TYPE__SS_PERIPH_DISABLED_CLR__MASK                   0x00400000U
#define OTGCMD_TYPE__DEV_VBUS_DEB_SHORT_SET__MASK                   0x20000000U
#define OTGCMD_TYPE__DEV_VBUS_DEB_SHORT_CLR__MASK                   0x40000000U
...
#define OTGREFCLK_TYPE__OTG_STB_CLK_SWITCH_EN__READ(src) \
                    (((uint32_t)(src)\
                    & 0x80000000U) >> 31)
#define OTGREFCLK_TYPE__OTG_STB_CLK_SWITCH_EN__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x80000000U) | ((uint32_t)(1) << 31)
#define OTGREFCLK_TYPE__OTG_STB_CLK_SWITCH_EN__CLR(dst) \
                    (dst) = ((dst) &\
...
#ifndef __TYPEC_CFG_TYPE_MACRO__
#define __TYPEC_CFG_TYPE_MACRO__

/* macros for field TYPEC_ALT_MODE */
#define TYPEC_CFG_TYPE__TYPEC_ALT_MODE__MASK                        0x00000001U
#define TYPEC_CFG_TYPE__TYPE                                           uint32_t
#endif /* __TYPEC_CFG_TYPE_MACRO__ */


/* macros for usbdrd_register_block.TYPEC_CFG */
#endif /* __REG_USBSS_DRD_ADDR_MAP_MACRO_H__ */
