...
/* Internal command of controller to update clock only */
#define SDMMC_CMD_UPDATE_CLK		0xFF
...
#define SDMMC_CMD_CARD_NUM(n)		((n) << 16)
...
struct dw_mci_drv_data {
	...
	int		(*switch_voltage)(struct mmc_host *mmc,
					  struct mmc_ios *ios);
	void		(*set_phase)(struct dw_mci_slot *slot);
};
#endif /* _DW_MMC_H_ */
