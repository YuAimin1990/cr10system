...
#define SIRIUS_ETH_PWR_CTRL   0x1000
#define SIRIUS_ETH_RST_CTRL   0x1004
#define SIRIUS_ETH_TX_BRIDGE  0x100C
#define SIRIUS_ETH_RX_BRIDGE  0x1010
#define SIRIUS_ETH_RMII_CTRL  0x101c

#define SIRIUS_ETH_RMII_SEL   0x40 //bit 6 is rmii/rgmii selection
...
#define  OETH_TX_BD_SEND		(OETH_TX_BD_READY | OETH_TX_BD_IRQ | OETH_TX_BD_PAD | OETH_TX_BD_CRC)
...
#define OETH_INT_MASK_RXPL_M    0x00000080 /* Received Control Frame IRQ Mask */
#define OETH_INT_MASK_RXPL_M1   0x00000100 /* Received Control Frame IRQ Mask */
#define OETH_INT_MASK_RXPL_M2   0x00000200 /* Received Control Frame IRQ Mask */


#define OETH_INT_MASK_ALL	(OETH_INT_MASK_TXB | OETH_INT_MASK_TXE | \
				 OETH_INT_MASK_RXF | OETH_INT_MASK_RXE | \
				 OETH_INT_MASK_TXC | \
				 OETH_INT_MASK_RXC | OETH_INT_MASK_RXPL_M | OETH_INT_MASK_RXPL_M1 | OETH_INT_MASK_RXPL_M2)
