...
enum
{
    AR_DVP_OUT_CSC_BT709_LIMIT, // bt709 limit
    AR_DVP_OUT_CSC_BT709_FULL,  // bt709 full range
    AR_DVP_OUT_CSC_BT601_LIMIT, // bt601 limit
    AR_DVP_OUT_CSC_BT601_FULL,  // bt601 full
    AR_DVP_OUT_CSC_DEFAULT,
};
