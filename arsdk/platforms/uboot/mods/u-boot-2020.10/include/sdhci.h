...
#define SDHCI_QUIRK_HOST_CMD_RETRY	(1 << 9)
...
struct sdhci_ops {
	...
	int	(*cmd_pre_retry)(struct sdhci_host *host, struct mmc_cmd *cmd, u32 stat);
	int	(*cmd_post_retry)(struct sdhci_host *host, struct mmc_cmd *cmd, u32 stat);
};
