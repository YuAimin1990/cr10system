 ...
 *
 *
 * Configuration settings for the Artosyn series of boards.
 *
...
#define ARTOSYN_EMULATION   /*For emulation use only*/

#define CONFIG_SYS_MAX_NAND_DEVICE 1
#define CONFIG_SYS_NAND_U_BOOT_OFFS 0x260000
#define CONFIG_SYS_NAND_ATF_OFFS 0x260000
...
#define CONFIG_SPL_BSS_START_ADDR	0x00139000
#define CONFIG_SPL_BSS_MAX_SIZE		0x8000

/*#define CONFIG_SYS_PROMPT	"artosyn#" */

/* Serial & console */
#define CONFIG_SYS_NS16550_SERIAL
#define CONFIG_SYS_NS16550_COM1  ARTOSYN_UART0_BASE

/* NS16550 reg in the low bits of cpu reg, FPGA clk 60M */
#ifdef FPGA_SIMULATION
#define CONFIG_SYS_NS16550_CLK		40000000
#define CONFIG_DW_WDT_CLOCK_KHZ		24000
#else
#define CONFIG_SYS_NS16550_CLK		150000000
#define CONFIG_DW_WDT_CLOCK_KHZ		24000
#endif

#define CONFIG_DW_WDT_BASE		0x01600000

//#define CONFIG_GICV2
//#define GICD_BASE			0x01000000
//#define GICC_BASE			0x01001000
...
#define CONFIG_SPL_STACK			0x00152bff /* 0x00129c00 - 1 */
...
//#else
//#error Unsupported console port nr. Please fix stdout-path in artosyn-common.h.
//#endif

/* GPIO */

/* Ethernet support */
#ifdef CONFIG_ARTOSYN_GMAC
...
#ifdef CONFIG_USB_MUSB_ARTOSYN
#define CONFIG_MUSB_HOST
#define CONFIG_MUSB_PIO_ONLY
#endif

#if defined CONFIG_USB_EHCI || defined CONFIG_USB_MUSB_ARTOSYN
...
#define SIRIUS_ETH_MAC_ADDR  "ethaddr=00:00:01:02:03:04\0"
#define CONFIG_ETHPRIME "sirius-gmac"
#define CONFIG_IPADDR  192.168.199.138
#define CONFIG_SERVERIP 192.168.199.114
