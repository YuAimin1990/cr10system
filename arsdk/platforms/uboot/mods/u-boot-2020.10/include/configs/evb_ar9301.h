 ...
 *
 * Configuration settings for the Artosyn sirius CPU
 *
 * SPDX-License-Identifier:	GPL-2.0+
 */

#ifndef __EVB_AR9301_CONFIG_H
#define __EVB_AR9301_CONFIG_H

/*
 * Include common sirius configuration where most the settings are
 */
#include "ar9301_common.h"

/*
 * Sirius specific configuration
 */
