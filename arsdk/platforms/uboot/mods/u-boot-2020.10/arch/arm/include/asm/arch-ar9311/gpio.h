...
#ifndef _ARTOSYN_GPIO_H
#define _ARTOSYN_GPIO_H
...
void pin_share_config(int pin, int func);
void sirius_gpio_set_value(unsigned int group, unsigned int port, unsigned int gpio, unsigned int val);
unsigned int sirius_gpio_get_value(unsigned int group, unsigned int port, unsigned int gpio);
void sirius_gpio_set_direction(unsigned int group, unsigned int port, unsigned int gpio, unsigned int direction);
unsigned int sirius_gpio_get_direction(unsigned int group, unsigned int port, unsigned int gpio);
int sirius_pinshare_from_env(void);
#endif /* _ARTOSYN_GPIO_H */
