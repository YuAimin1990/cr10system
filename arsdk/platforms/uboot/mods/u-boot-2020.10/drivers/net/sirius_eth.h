#ifndef __SIRIUS_ETH_H__
#define __SIRIUS_ETH_H__
...
#define SIRIUS_ETH_REG_BASE  ARTOSYN_GMAC_BASE 
#define SIRIUS_ETH_BD_BASE   (ARTOSYN_GMAC_BASE + 0x400)
#define SIRIUS_ETH_TXBD_OFFSET  0x400
#define SIRIUS_ETH_TOTAL_BD  128
//#define SIRIUS_ETH_MAXBUF_LEN 0x600

#define SIRIUS_ETH_TXBD_NUM      64
#define SIRIUS_ETH_TXBD_NUM_MASK (SIRIUS_ETH_TXBD_NUM - 1)
#define SIRIUS_ETH_RXBD_NUM      64
#define SIRIUS_ETH_RXBD_NUM_MASK (SIRIUS_ETH_RXBD_NUM - 1)
#define SIRIUS_ETH_RXBD_OFFSET   (SIRIUS_ETH_TXBD_OFFSET + SIRIUS_ETH_TXBD_NUM * 8)
#define CONFIG_MDIO_TIMEOUT (3*CONFIG_SYS_HZ)

#define GMAC_PWR_CTRL_REG         (SIRIUS_ETH_REG_BASE + 0x1000)
#define GBE_RSTN_CTRL_REG         (SIRIUS_ETH_REG_BASE + 0x1004)
#define GBE_TX_CTRL_REG           (SIRIUS_ETH_REG_BASE + 0x100c)
#define GBE_RX_CTRL_REG           (SIRIUS_ETH_REG_BASE + 0x1010)
...
#define SIRIUS_ETH_DEV_NAME "sirius-gmac"
/* Ethernet buffer descriptor */
struct sirius_eth_bd {
        volatile unsigned int   len_status;     /* Buffer length and status */
        volatile unsigned int   addr;          /* Buffer address */
};

struct sirius_eth_dev 
{
	//struct sirius_eth_bd tx_mac_descrtable[SIRIUS_ETH_TXBD_NUM];
	//struct sirius_eth_bd rx_mac_descrtable[SIRIUS_ETH_RXBD_NUM];
	//u32 tx_currdescnum;
	//u32 rx_currdescnum;

	//the bd should be pointed to bd inside the GMAC, which is base_addr+0x400.
	struct sirius_eth_bd * tx_mac_descrtable;
	struct sirius_eth_bd * rx_mac_descrtable;
...
extern int sirius_eth_initialize(ulong base_addr, unsigned int interface, unsigned char *enetaddr);
#endif
