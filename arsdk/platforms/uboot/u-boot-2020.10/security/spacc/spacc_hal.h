...
static inline void spacc_write_reg32(unsigned int reg32, unsigned int value)
{
	*(volatile unsigned int *)((unsigned long)reg32) = value;
}

static inline unsigned int spacc_read_reg32(unsigned int reg32)
{
	return *(volatile unsigned int *)((unsigned long)reg32);
}
