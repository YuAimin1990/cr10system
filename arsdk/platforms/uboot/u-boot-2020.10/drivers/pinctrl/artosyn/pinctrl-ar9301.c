...
static int ar9301_pinctrl_pb_msc_config(struct udevice *dev)
{
	struct ar9301_pinctrl_priv *priv = NULL;
...
static int ar9301_pinctrl_probe(struct udevice *dev)
{
	struct ar9301_pinctrl_priv *priv = dev_get_priv(dev);
	u32 size, i, j;
	u32 pads_num;
	u32 *pads_info = NULL;
	u32 pad;
...
#define PINCTRL_BASE_NUM 	4
	...
	priv->pb_sw_reg_base = (void *)tmp[0];
	priv->pad_func_sel_base = (void *)tmp[2];
...
#ifndef CONFIG_SPL_BUILD
	ret = ar9301_pinctrl_pb_msc_config(dev);
#endif
...
static int ar9301_pinctrl_set_state_simple(struct udevice *dev,
...
const struct pinctrl_ops single_pinctrl_ops = {
	.set_state_simple = ar9301_pinctrl_set_state_simple,
};

static const struct udevice_id ar9301_pinctrl_match[] = {
	{ .compatible = "artosyn,ar9301-pinctrl" },
	{ /* sentinel */ }
};

U_BOOT_DRIVER(ar9301_pinctrl) = {
	.name = "artosyn_ar9301_pinctrl",
	.id = UCLASS_PINCTRL,
	.of_match = ar9301_pinctrl_match,
	.priv_auto_alloc_size = sizeof(struct ar9301_pinctrl_priv),
	.ops = &single_pinctrl_ops,
#if !CONFIG_IS_ENABLED(OF_PLATDATA)
	.bind		= dm_scan_fdt_dev,
#endif
	.probe		= ar9301_pinctrl_probe,
};
