...
#ifndef __DT_BINDINGS_PINCTRL_AR9301_H__
#define __DT_BINDINGS_PINCTRL_AR9301_H__
...
#define PIN110	0x006E0000
#define PIN111	0x006F0000
#define PIN112	0x00700000
#define PIN113	0x00710000
#define PIN114	0x00720000
#define PIN115	0x00730000
#define PIN116	0x00740000
#define PIN117	0x00750000
#define PIN118	0x00760000
#define PIN119	0x00770000
#define PIN120	0x00780000
#define PIN121	0x00790000
#define PIN122	0x007A0000
#define PIN123	0x007B0000
#define PIN124	0x007C0000
#define PIN125	0x007D0000
#define PIN126	0x007E0000
#define PIN127	0x007F0000
#define PIN128	0x00800000
#define PIN129	0x00810000
#define PIN130	0x00820000
#define PIN131	0x00830000
#define PIN132	0x00840000
#define PIN133	0x00850000
#define PIN134	0x00860000
#define PIN135	0x00870000
#define PIN136	0x00880000
#define PIN137	0x00890000
#define PIN138	0x008A0000
#define PIN139	0x008B0000
#define PIN140	0x008C0000
#define PIN141	0x008D0000
#define PIN142	0x008E0000
#define PIN143	0x008F0000
#define PIN144	0x00900000
#define PIN145	0x00910000
#define PIN146	0x00920000
#define PIN147	0x00930000
#define PIN148	0x00940000
#define PIN149	0x00950000
#define PIN150	0x00960000
#define PIN151	0x00970000
#define PIN152	0x00980000
#define PIN153	0x00990000
#define PIN154	0x009A0000
#define PIN155	0x009B0000
#define PIN156	0x009C0000
#define PIN157	0x009D0000
#define PIN158	0x009E0000
#define PIN159	0x009F0000
#define PIN160	0x00A00000
#define PIN161	0x00A10000
#define PIN162	0x00A20000
#define PIN163	0x00A30000
#define PIN164	0x00A40000
#define PIN165	0x00A50000
#define PIN166	0x00A60000
#define PIN167	0x00A70000
#define PIN168	0x00A80000
#define PIN169	0x00A90000
#define PIN170	0x00AA0000
#define PIN171	0x00AB0000
#define PIN172	0x00AC0000
#define PIN173	0x00AD0000
#define PIN174	0x00AE0000
#define PIN175	0x00AF0000
#define PIN176	0x00B00000
#define PIN177	0x00B10000
#define PIN178	0x00B20000
#define PIN179	0x00B30000
#define PIN180	0x00B40000
#define PIN181	0x00B50000
#define PIN182	0x00B60000
#define PIN183	0x00B70000
#define PIN184	0x00B80000
#define PIN185	0x00B90000
#define PIN186	0x00BA0000
#define PIN187	0x00BB0000
#define PIN188	0x00BC0000
#define PIN189	0x00BD0000
#define PIN190	0x00BE0000
#define PIN191	0x00BF0000
#define PIN192	0x00C00000
...
#define DRIVING_SELECTOR_1	0x0008
#define DRIVING_SELECTOR_2	0x0010
#define DRIVING_SELECTOR_3	0x0018

#define NO_PULL			0x0000
#define PULL_DOWN		0x0020
#define PULL_UP			0x0040
#define PULL_UP_AND_DOWN	0x0060

#define SCHMITT_TRIGGER_DISABLE	0x0000
#define SCHMITT_TRIGGER_ENABLE	0x0080

#define SLEW_RATE_DISABLE	0x0000
#define SLEW_RATE_ENABLE	0x0100

#define PB_MSC_BIT0               0     /**< PB085_086, PB089_092 */
#define PB_MSC_BIT1               1     /**< PB093_098 */
#define PB_MSC_BIT2               2     /**< PB102_107 */
#define PB_MSC_BIT3               3     /**< PB111_116 */
#define PB_MSC_BIT4               4     /**< PB117_121 */
#define PB_MSC_BIT5               5     /**< PB002_025 */
#define PB_MSC_BIT6               6     /**< PB026_049 */
#define PB_MSC_BIT7               7     /**< PB050_081 */
#define PB_MSC_BIT8               8     /**< PB082_083, PB140_143 */
#define PB_MSC_BIT9               9     /**< PB084, PB087_088, PB099_101, PB108_110, PB122_139, PB144_174, PB192 */
#define PB_MSC_BIT10              10    /**< PB175_191 */
