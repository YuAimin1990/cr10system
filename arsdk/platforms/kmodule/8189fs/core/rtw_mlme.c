...
#define RTW_ROAM_RSSI_DIFF_TH 7
#define RTW_ROAM_SCAN_INTERVAL (4)    /* 5*(2 second)*/
#define RTW_ROAM_RSSI_THRESHOLD 65
...
//pax modify for roaming faster
#if 0//def CONFIG_LAYER2_ROAMING
