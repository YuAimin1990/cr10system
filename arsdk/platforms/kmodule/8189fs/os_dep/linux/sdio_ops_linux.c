...
extern u8 rtw_sdio_trace_en;
#define rtw_sdio_trace(addr, cnt) do { if (rtw_sdio_trace_en) RTW_PRINT("[SDIO_TRACE] %s: addr=0x%05x cnt=%u\n", __func__, addr, cnt); rtw_warn_on(rtw_sdio_trace_en > 1); } while (0)
