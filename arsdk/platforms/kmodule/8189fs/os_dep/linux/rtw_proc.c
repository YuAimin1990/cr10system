...
static ssize_t proc_set_sdio_trace_en(struct file *file, const char __user *buffer, size_t count, loff_t *pos, void *data)
{
	char tmp[32];
	u8 enable;
...
#endif /* DBG_MEM_ALLOC */
#ifdef CONFIG_SDIO_HCI
	RTW_PROC_HDL_SSEQ("sdio_trace_en", NULL, proc_set_sdio_trace_en),
#endif
